...
-- ldbanno -n VHDL -o stp_stp_mapvho.vho -w -neg -gui stp_stp_map.ncd 
-- Netlist created on Wed Nov 14 13:16:54 2018
-- Netlist written on Wed Nov 14 13:17:04 2018
...
-- entity I7_SLICE_0
  ...
  entity I7_SLICE_0 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_0";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_0 : ENTITY IS TRUE;

  end I7_SLICE_0;

  architecture Structure of I7_SLICE_0 is
...
-- entity I7_SLICE_1
  ...
  entity I7_SLICE_1 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_1";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_1 : ENTITY IS TRUE;

  end I7_SLICE_1;

  architecture Structure of I7_SLICE_1 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i20: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i19: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_21: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_2
  ...
  entity I7_SLICE_2 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_2";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_2 : ENTITY IS TRUE;

  end I7_SLICE_2;

  architecture Structure of I7_SLICE_2 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i10: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i9: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_11: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_3
  ...
  entity I7_SLICE_3 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_3";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_3 : ENTITY IS TRUE;

  end I7_SLICE_3;

  architecture Structure of I7_SLICE_3 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i8: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i7: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_9: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_4
  ...
  entity I7_SLICE_4 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_4";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_4 : ENTITY IS TRUE;

  end I7_SLICE_4;

  architecture Structure of I7_SLICE_4 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i31: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_add_4_33: ccu20001
...
-- entity I7_SLICE_5
  ...
  entity I7_SLICE_5 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_5";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_5 : ENTITY IS TRUE;

  end I7_SLICE_5;

  architecture Structure of I7_SLICE_5 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i30: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i29: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_31: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_6
  ...
  entity I7_SLICE_6 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_6";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_6 : ENTITY IS TRUE;

  end I7_SLICE_6;

  architecture Structure of I7_SLICE_6 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i28: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i27: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_29: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_7
  ...
  entity I7_SLICE_7 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_7";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_7 : ENTITY IS TRUE;

  end I7_SLICE_7;

  architecture Structure of I7_SLICE_7 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i26: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i25: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_27: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_8
  ...
  entity I7_SLICE_8 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_8";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_8 : ENTITY IS TRUE;

  end I7_SLICE_8;

  architecture Structure of I7_SLICE_8 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i6: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i5: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_7: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_9
  ...
  entity I7_SLICE_9 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_9";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_9 : ENTITY IS TRUE;

  end I7_SLICE_9;

  architecture Structure of I7_SLICE_9 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i24: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i23: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_25: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_10
  ...
  entity I7_SLICE_10 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_10";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_10 : ENTITY IS TRUE;

  end I7_SLICE_10;

  architecture Structure of I7_SLICE_10 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i14: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i13: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_15: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_11
  ...
  entity I7_SLICE_11 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_11";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_11 : ENTITY IS TRUE;

  end I7_SLICE_11;

  architecture Structure of I7_SLICE_11 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i4: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i3: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_5: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_12
  ...
  entity I7_SLICE_12 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_12";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_12 : ENTITY IS TRUE;

  end I7_SLICE_12;

  architecture Structure of I7_SLICE_12 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i12: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i11: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_13: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_13
  ...
  entity I7_SLICE_13 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_13";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_13 : ENTITY IS TRUE;

  end I7_SLICE_13;

  architecture Structure of I7_SLICE_13 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i18: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i17: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_19: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_14
  ...
  entity I7_SLICE_14 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_14";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_14 : ENTITY IS TRUE;

  end I7_SLICE_14;

  architecture Structure of I7_SLICE_14 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i22: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i21: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_23: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_15
  ...
  entity I7_SLICE_15 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_15";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_15 : ENTITY IS TRUE;

  end I7_SLICE_15;

  architecture Structure of I7_SLICE_15 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i2: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_i1: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    I7_dec_cnt_201_add_4_3: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity I7_SLICE_16
  ...
  entity I7_SLICE_16 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_16";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_16 : ENTITY IS TRUE;

  end I7_SLICE_16;

  architecture Structure of I7_SLICE_16 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_dec_cnt_201_i0: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I7_dec_cnt_201_add_4_1: ccu20002
...
-- entity I2_SLICE_17
  ...
  entity I2_SLICE_17 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I2_SLICE_17";
    ...
    ATTRIBUTE Vital_Level0 OF I2_SLICE_17 : ENTITY IS TRUE;

  end I2_SLICE_17;

  architecture Structure of I2_SLICE_17 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
...
-- entity I2_SLICE_18
  ...
  entity I2_SLICE_18 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I2_SLICE_18";
    ...
    ATTRIBUTE Vital_Level0 OF I2_SLICE_18 : ENTITY IS TRUE;

  end I2_SLICE_18;

  architecture Structure of I2_SLICE_18 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I2_i1663_1_lut: lut40005
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I2_cnt_203_i0: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I6_SLICE_19
  ...
  entity I6_SLICE_19 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_19";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_19 : ENTITY IS TRUE;

  end I6_SLICE_19;

  architecture Structure of I6_SLICE_19 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i19_1_lut: lut40005
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I6_SigClk100Hz_37: vmuxregsre0006
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I6_SLICE_20
  ...
  entity I6_SLICE_20 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_20";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_20 : ENTITY IS TRUE;

  end I6_SLICE_20;

  architecture Structure of I6_SLICE_20 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1_2_lut_adj_2: lut40003
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I6_Counter_Clk1Hz_34: vmuxregsre0006
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I6_SLICE_21
  ...
  entity I6_SLICE_21 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_21";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_21 : ENTITY IS TRUE;

  end I6_SLICE_21;

  architecture Structure of I6_SLICE_21 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1_2_lut_adj_1: lut40003
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I6_Counter_Clk3Hz_32: vmuxregsre0006
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I6_SLICE_22
  ...
  entity I6_SLICE_22 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_22";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_22 : ENTITY IS TRUE;

  end I6_SLICE_22;

  architecture Structure of I6_SLICE_22 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1600_2_lut_3_lut_4_lut: lut40007
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I6_i1593_2_lut_3_lut: lut40008
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I6_Counter_Counter1Hz_209_i3: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I6_Counter_Counter1Hz_209_i2: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity I6_SLICE_23
  ...
  entity I6_SLICE_23 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_23";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_23 : ENTITY IS TRUE;

  end I6_SLICE_23;

  architecture Structure of I6_SLICE_23 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1614_2_lut_4_lut: lut4
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I6_i1607_2_lut_3_lut_4_lut: lut40007
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    I6_Counter_Counter1Hz_209_i5: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I6_Counter_Counter1Hz_209_i4: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity I6_SLICE_24
  ...
  entity I6_SLICE_24 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_24";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_24 : ENTITY IS TRUE;

  end I6_SLICE_24;

  architecture Structure of I6_SLICE_24 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1596_2_lut_rep_26_3_lut: lut40009
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I6_i1621_3_lut: lut40010
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    I6_Counter_Counter1Hz_209_i6: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I6_SLICE_25
  ...
  entity I6_SLICE_25 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_25";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_25 : ENTITY IS TRUE;

  end I6_SLICE_25;

  architecture Structure of I6_SLICE_25 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1759_2_lut_3_lut: lut40008
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I6_i1752_2_lut: lut40003
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    I6_Counter_Counter3Hz_207_i2: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I6_Counter_Counter3Hz_207_i1: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity I6_SLICE_26
  ...
  entity I6_SLICE_26 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_26";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_26 : ENTITY IS TRUE;

  end I6_SLICE_26;

  architecture Structure of I6_SLICE_26 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1773_2_lut_3_lut_4_lut: lut40007
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I6_i1766_2_lut_3_lut_4_lut: lut40007
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    I6_Counter_Counter3Hz_207_i4: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I6_Counter_Counter3Hz_207_i3: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity I6_SLICE_27
  ...
  entity I6_SLICE_27 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_27";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_27 : ENTITY IS TRUE;

  end I6_SLICE_27;

  architecture Structure of I6_SLICE_27 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1762_2_lut_rep_25_3_lut: lut40009
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I6_i1780_3_lut_4_lut: lut4
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    I6_Counter_Counter3Hz_207_i5: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I6_SLICE_28
  ...
  entity I6_SLICE_28 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_28";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_28 : ENTITY IS TRUE;

  end I6_SLICE_28;

  architecture Structure of I6_SLICE_28 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1584_1_lut: lut40005
      port map (A=>A1_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I6_i1586_2_lut: lut40003
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    I6_Counter_Counter1Hz_209_i0: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I6_Counter_Counter1Hz_209_i1: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity I6_SLICE_29
  ...
  entity I6_SLICE_29 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_29";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_29 : ENTITY IS TRUE;

  end I6_SLICE_29;

  architecture Structure of I6_SLICE_29 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1755_2_lut_rep_30: lut40011
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I6_i1750_1_lut: lut40005
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    I6_Counter_Counter3Hz_207_i0: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I2_SLICE_30
  ...
  entity I2_SLICE_30 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I2_SLICE_30";
    ...
    ATTRIBUTE Vital_Level0 OF I2_SLICE_30 : ENTITY IS TRUE;

  end I2_SLICE_30;

  architecture Structure of I2_SLICE_30 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I2_i1_2_lut_4_lut: lut40012
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    I2_Cout_18: vmuxregsre0006
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I3_SLICE_31
  ...
  entity I3_SLICE_31 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I3_SLICE_31";
    ...
    ATTRIBUTE Vital_Level0 OF I3_SLICE_31 : ENTITY IS TRUE;

  end I3_SLICE_31;

  architecture Structure of I3_SLICE_31 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I3_i776_2_lut: lut40011
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I3_i1331_4_lut: lut40013
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    I3_Cout_18: vmuxregsre0006
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I4_SLICE_32
  ...
  entity I4_SLICE_32 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I4_SLICE_32";
    ...
    ATTRIBUTE Vital_Level0 OF I4_SLICE_32 : ENTITY IS TRUE;

  end I4_SLICE_32;

  architecture Structure of I4_SLICE_32 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I4_i777_2_lut: lut40011
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I4_i1327_4_lut: lut40013
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    I4_Cout_18: vmuxregsre0006
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I1_SLICE_34
  ...
  entity I1_SLICE_34 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I1_SLICE_34";
    ...
    ATTRIBUTE Vital_Level0 OF I1_SLICE_34 : ENTITY IS TRUE;

  end I1_SLICE_34;

  architecture Structure of I1_SLICE_34 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I1_i1636_2_lut: lut40003
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I1_i1634_1_lut: lut40005
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    I1_cnt_202_i1: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I1_cnt_202_i0: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity I1_SLICE_35
  ...
  entity I1_SLICE_35 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I1_SLICE_35";
    ...
    ATTRIBUTE Vital_Level0 OF I1_SLICE_35 : ENTITY IS TRUE;

  end I1_SLICE_35;

  architecture Structure of I1_SLICE_35 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I1_i1650_3_lut_4_lut: lut4
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I1_i1643_2_lut_3_lut: lut40008
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I1_cnt_202_i3: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    I1_cnt_202_i2: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity I3_SLICE_36
  ...
  entity I3_SLICE_36 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I3_SLICE_36";
    ...
    ATTRIBUTE Vital_Level0 OF I3_SLICE_36 : ENTITY IS TRUE;

  end I3_SLICE_36;

  architecture Structure of I3_SLICE_36 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I3_i1692_1_lut: lut40005
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I3_cnt_204_i0: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I4_SLICE_37
  ...
  entity I4_SLICE_37 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I4_SLICE_37";
    ...
    ATTRIBUTE Vital_Level0 OF I4_SLICE_37 : ENTITY IS TRUE;

  end I4_SLICE_37;

  architecture Structure of I4_SLICE_37 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I4_i1721_1_lut: lut40005
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I4_cnt_205_i0: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I3_SLICE_38
  ...
  entity I3_SLICE_38 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I3_SLICE_38";
    ...
    ATTRIBUTE Vital_Level0 OF I3_SLICE_38 : ENTITY IS TRUE;

  end I3_SLICE_38;

  architecture Structure of I3_SLICE_38 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I3_i1694_2_lut: lut40003
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I3_cnt_204_i1: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I4_SLICE_39
  ...
  entity I4_SLICE_39 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I4_SLICE_39";
    ...
    ATTRIBUTE Vital_Level0 OF I4_SLICE_39 : ENTITY IS TRUE;

  end I4_SLICE_39;

  architecture Structure of I4_SLICE_39 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I4_i1723_2_lut: lut40003
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I4_cnt_205_i1: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I2_SLICE_40
  ...
  entity I2_SLICE_40 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I2_SLICE_40";
    ...
    ATTRIBUTE Vital_Level0 OF I2_SLICE_40 : ENTITY IS TRUE;

  end I2_SLICE_40;

  architecture Structure of I2_SLICE_40 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I2_i1672_2_lut_3_lut: lut40008
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I2_cnt_203_i2: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    ...
    VitalBehavior : PROCESS (C0_ipd, B0_ipd, A0_ipd, DI0_dly, CE_dly, LSR_dly, 
      CLK_dly, F0_out, Q0_out)
    VARIABLE F0_zd         	: std_logic := 'X';
    VARIABLE F0_GlitchData 	: VitalGlitchDataType;
    VARIABLE Q0_zd         	: std_logic := 'X';
...
-- entity SLICE_41
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I3_i1701_2_lut_3_lut: lut40008
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    I3_cnt_204_i2: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_42
  ...
  begin
    I7_i21_4_lut: lut40015
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I4_i1730_2_lut_3_lut: lut40008
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I4_cnt_205_i2: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_43
  ...
  begin
    I7_i3_2_lut: lut40016
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I3_i1708_3_lut_4_lut: lut4
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    I3_cnt_204_i3: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_44
  ...
  begin
    I7_i14_2_lut: lut40016
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I4_i1737_3_lut_4_lut: lut4
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    I4_cnt_205_i3: vmuxregsre0004
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>CE_dly, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity I2_i1934_SLICE_45
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity I2_i1934_SLICE_45 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I2_i1934_SLICE_45";
    ...
    ATTRIBUTE Vital_Level0 OF I2_i1934_SLICE_45 : ENTITY IS TRUE;

  end I2_i1934_SLICE_45;

  architecture Structure of I2_i1934_SLICE_45 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    signal GNDI: Std_logic;
    signal I2_i1934_SLICE_45_I2_i1934_SLICE_45_K1_H1: Std_logic;
    signal I2_i1934_SLICE_45_I2_i1934_GATE_H0: Std_logic;
    component gnd
      port (PWR0: out Std_logic);
    end component;
    component lut40017
  ...
  begin
    I2_i1934_SLICE_45_K1: lut40017
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, 
                Z=>I2_i1934_SLICE_45_I2_i1934_SLICE_45_K1_H1);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I2_i1934_GATE: lut40018
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, 
                Z=>I2_i1934_SLICE_45_I2_i1934_GATE_H0);
    I2_i1934_SLICE_45_K0K1MUX: selmux2
      port map (D0=>I2_i1934_SLICE_45_I2_i1934_GATE_H0, 
                D1=>I2_i1934_SLICE_45_I2_i1934_SLICE_45_K1_H1, SD=>M0_ipd, 
                Z=>OFX0_out);
...
-- entity I2_i1937_SLICE_46
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity I2_i1937_SLICE_46 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I2_i1937_SLICE_46";
    ...
    ATTRIBUTE Vital_Level0 OF I2_i1937_SLICE_46 : ENTITY IS TRUE;

  end I2_i1937_SLICE_46;

  architecture Structure of I2_i1937_SLICE_46 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    signal GNDI: Std_logic;
    signal I2_i1937_SLICE_46_I2_i1937_SLICE_46_K1_H1: Std_logic;
    signal I2_i1937_SLICE_46_I2_i1937_GATE_H0: Std_logic;
    component gnd
      port (PWR0: out Std_logic);
    end component;
    component lut40017
  ...
  begin
    I2_i1937_SLICE_46_K1: lut40017
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, 
                Z=>I2_i1937_SLICE_46_I2_i1937_SLICE_46_K1_H1);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I2_i1937_GATE: lut40018
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, 
                Z=>I2_i1937_SLICE_46_I2_i1937_GATE_H0);
    I2_i1937_SLICE_46_K0K1MUX: selmux2
      port map (D0=>I2_i1937_SLICE_46_I2_i1937_GATE_H0, 
                D1=>I2_i1937_SLICE_46_I2_i1937_SLICE_46_K1_H1, SD=>M0_ipd, 
                Z=>OFX0_out);
...
-- entity I2_i1943_SLICE_47
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity I2_i1943_SLICE_47 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I2_i1943_SLICE_47";
    ...
    ATTRIBUTE Vital_Level0 OF I2_i1943_SLICE_47 : ENTITY IS TRUE;

  end I2_i1943_SLICE_47;

  architecture Structure of I2_i1943_SLICE_47 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    signal GNDI: Std_logic;
    signal I2_i1943_SLICE_47_I2_i1943_SLICE_47_K1_H1: Std_logic;
    signal I2_i1943_SLICE_47_I2_i1943_GATE_H0: Std_logic;
    component gnd
      port (PWR0: out Std_logic);
    end component;
    component lut40017
  ...
  begin
    I2_i1943_SLICE_47_K1: lut40017
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, 
                Z=>I2_i1943_SLICE_47_I2_i1943_SLICE_47_K1_H1);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I2_i1943_GATE: lut40018
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, 
                Z=>I2_i1943_SLICE_47_I2_i1943_GATE_H0);
    I2_i1943_SLICE_47_K0K1MUX: selmux2
      port map (D0=>I2_i1943_SLICE_47_I2_i1943_GATE_H0, 
                D1=>I2_i1943_SLICE_47_I2_i1943_SLICE_47_K1_H1, SD=>M0_ipd, 
                Z=>OFX0_out);
...
-- entity lut40019
  ...
  begin
    INST10: ROM16X1A
      generic map (initval => X"FD20")
      port map (AD0=>A, AD1=>B, AD2=>C, AD3=>D, DO0=>Z);
  end Structure;

-- entity I7_i1928_SLICE_48
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity I7_i1928_SLICE_48 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_i1928_SLICE_48";
    ...
    ATTRIBUTE Vital_Level0 OF I7_i1928_SLICE_48 : ENTITY IS TRUE;

  end I7_i1928_SLICE_48;

  architecture Structure of I7_i1928_SLICE_48 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    signal I7_i1928_SLICE_48_I7_i1928_SLICE_48_K1_H1: Std_logic;
    signal I7_i1928_SLICE_48_I7_i1928_GATE_H0: Std_logic;
    component selmux2
      port (D0: in Std_logic; D1: in Std_logic; SD: in Std_logic; 
            Z: out Std_logic);
    end component;
  ...
  begin
    I7_i1928_SLICE_48_K1: lut40019
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, 
                Z=>I7_i1928_SLICE_48_I7_i1928_SLICE_48_K1_H1);
    I7_i1928_GATE: lut40019
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, 
                Z=>I7_i1928_SLICE_48_I7_i1928_GATE_H0);
    I7_i1928_SLICE_48_K0K1MUX: selmux2
      port map (D0=>I7_i1928_SLICE_48_I7_i1928_GATE_H0, 
                D1=>I7_i1928_SLICE_48_I7_i1928_SLICE_48_K1_H1, SD=>M0_ipd, 
                Z=>OFX0_out);
...
-- entity I6_i1940_SLICE_49
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity I6_i1940_SLICE_49 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_i1940_SLICE_49";
    ...
    ATTRIBUTE Vital_Level0 OF I6_i1940_SLICE_49 : ENTITY IS TRUE;

  end I6_i1940_SLICE_49;

  architecture Structure of I6_i1940_SLICE_49 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    signal GNDI: Std_logic;
    signal I6_i1940_SLICE_49_I6_i1940_SLICE_49_K1_H1: Std_logic;
    signal I6_i1940_SLICE_49_I6_i1940_GATE_H0: Std_logic;
    component gnd
      port (PWR0: out Std_logic);
    end component;
    component lut40017
  ...
  begin
    I6_i1940_SLICE_49_K1: lut40017
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, 
                Z=>I6_i1940_SLICE_49_I6_i1940_SLICE_49_K1_H1);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I6_i1940_GATE: lut40018
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, 
                Z=>I6_i1940_SLICE_49_I6_i1940_GATE_H0);
    I6_i1940_SLICE_49_K0K1MUX: selmux2
      port map (D0=>I6_i1940_SLICE_49_I6_i1940_GATE_H0, 
                D1=>I6_i1940_SLICE_49_I6_i1940_SLICE_49_K1_H1, SD=>M0_ipd, 
                Z=>OFX0_out);
...
-- entity I7_SLICE_50
  ...
  entity I7_SLICE_50 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_50";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_50 : ENTITY IS TRUE;

  end I7_SLICE_50;

  architecture Structure of I7_SLICE_50 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_mux_111_i2_4_lut: lut40020
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I7_s_3_bdd_4_lut_2059: lut40021
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_51
  ...
  entity I7_SLICE_51 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_51";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_51 : ENTITY IS TRUE;

  end I7_SLICE_51;

  architecture Structure of I7_SLICE_51 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i914_4_lut_4_lut: lut40022
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I7_i2004_4_lut: lut40023
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_52
  ...
  entity I7_SLICE_52 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_52";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_52 : ENTITY IS TRUE;

  end I7_SLICE_52;

  architecture Structure of I7_SLICE_52 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_s_0_bdd_4_lut: lut40024
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I7_mux_111_i1_4_lut_4_lut: lut40022
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_53
  ...
  entity I7_SLICE_53 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_53";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_53 : ENTITY IS TRUE;

  end I7_SLICE_53;

  architecture Structure of I7_SLICE_53 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_s_1_bdd_4_lut: lut40025
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I7_mux_111_i3_4_lut: lut40026
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I2_SLICE_54
  ...
  entity I2_SLICE_54 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I2_SLICE_54";
    ...
    ATTRIBUTE Vital_Level0 OF I2_SLICE_54 : ENTITY IS TRUE;

  end I2_SLICE_54;

  architecture Structure of I2_SLICE_54 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I2_i2_3_lut_rep_27: lut40027
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I2_i2_3_lut: lut40009
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
...
-- entity SLICE_55
  ...
  begin
    I1_i774_4_lut: lut40028
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I2_i1_2_lut: lut40016
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity I7_SLICE_56
  ...
  entity I7_SLICE_56 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_56";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_56 : ENTITY IS TRUE;

  end I7_SLICE_56;

  architecture Structure of I7_SLICE_56 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i27_4_lut: lut40015
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I7_i6_2_lut: lut40016
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity I7_SLICE_57
  ...
  entity I7_SLICE_57 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_57";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_57 : ENTITY IS TRUE;

  end I7_SLICE_57;

  architecture Structure of I7_SLICE_57 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i28_4_lut: lut40015
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I7_i15_3_lut: lut40027
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity I7_SLICE_58
  ...
  entity I7_SLICE_58 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_58";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_58 : ENTITY IS TRUE;

  end I7_SLICE_58;

  architecture Structure of I7_SLICE_58 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i17_4_lut: lut40015
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I7_i23_4_lut: lut40015
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_59
  ...
  entity I7_SLICE_59 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_59";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_59 : ENTITY IS TRUE;

  end I7_SLICE_59;

  architecture Structure of I7_SLICE_59 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i1_2_lut_rep_28: lut40011
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I7_mux_123_i1_3_lut_4_lut: lut40029
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_60
  ...
  entity I7_SLICE_60 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_60";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_60 : ENTITY IS TRUE;

  end I7_SLICE_60;

  architecture Structure of I7_SLICE_60 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i1_2_lut_rep_23: lut40016
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I7_mux_123_i3_4_lut: lut40020
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_61
  ...
  entity I7_SLICE_61 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_61";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_61 : ENTITY IS TRUE;

  end I7_SLICE_61;

  architecture Structure of I7_SLICE_61 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i1_2_lut: lut40030
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I7_mux_123_i2_3_lut_4_lut: lut40029
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_62
  ...
  entity I7_SLICE_62 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_62";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_62 : ENTITY IS TRUE;

  end I7_SLICE_62;

  architecture Structure of I7_SLICE_62 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i25_4_lut: lut40015
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I7_i11_2_lut: lut40016
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity I6_SLICE_63
  ...
  entity I6_SLICE_63 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_63";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_63 : ENTITY IS TRUE;

  end I6_SLICE_63;

  architecture Structure of I6_SLICE_63 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1610_2_lut_3_lut_rep_24_4_lut: lut40031
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I6_i1589_2_lut_rep_32: lut40011
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity I6_SLICE_64
  ...
  entity I6_SLICE_64 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_64";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_64 : ENTITY IS TRUE;

  end I6_SLICE_64;

  architecture Structure of I6_SLICE_64 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i2_4_lut: lut40028
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I6_i1_2_lut: lut40016
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity I6_SLICE_65
  ...
  entity I6_SLICE_65 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_SLICE_65";
    ...
    ATTRIBUTE Vital_Level0 OF I6_SLICE_65 : ENTITY IS TRUE;

  end I6_SLICE_65;

  architecture Structure of I6_SLICE_65 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I6_i1329_4_lut: lut40013
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I6_i2_2_lut: lut40016
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity I7_SLICE_66
  ...
  entity I7_SLICE_66 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_66";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_66 : ENTITY IS TRUE;

  end I7_SLICE_66;

  architecture Structure of I7_SLICE_66 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_s_1_bdd_4_lut_2046: lut40032
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I7_s_2_bdd_4_lut_2060: lut40033
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_67
  ...
  entity I7_SLICE_67 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_67";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_67 : ENTITY IS TRUE;

  end I7_SLICE_67;

  architecture Structure of I7_SLICE_67 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i1_3_lut_4_lut: lut40034
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    I7_mux_136_i1_3_lut_4_lut: lut40029
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_69
  ...
  entity I7_SLICE_69 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_69";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_69 : ENTITY IS TRUE;

  end I7_SLICE_69;

  architecture Structure of I7_SLICE_69 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i182_2_lut_rep_29: lut40030
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I7_mux_123_i4_4_lut: lut40036
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_70
  ...
  entity I7_SLICE_70 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_70";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_70 : ENTITY IS TRUE;

  end I7_SLICE_70;

  architecture Structure of I7_SLICE_70 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i7_2_lut: lut40016
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I7_i19_4_lut: lut40015
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity I7_SLICE_71
  ...
  entity I7_SLICE_71 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I7_SLICE_71";
    ...
    ATTRIBUTE Vital_Level0 OF I7_SLICE_71 : ENTITY IS TRUE;

  end I7_SLICE_71;

  architecture Structure of I7_SLICE_71 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    I7_i1_2_lut_adj_3: lut40030
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    I7_s_2_bdd_4_lut: lut40037
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
...
-- entity y_2_B
  ...
  entity y_2_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "y_2_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_y2	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; y2: out Std_logic);

    ATTRIBUTE Vital_Level0 OF y_2_B : ENTITY IS TRUE;

  end y_2_B;

  architecture Structure of y_2_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal y2_out 	: std_logic := 'X';
  ...
  begin
    y_pad_2: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>y2_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, y2_out)
    VARIABLE y2_zd         	: std_logic := 'X';
    ...
    VitalPathDelay01 (
      OutSignal => y2, OutSignalName => "y2", OutTemp => y2_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_y2,
                           PathCondition => TRUE)),
...
-- entity y_3_B
  ...
  entity y_3_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "y_3_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_y3	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; y3: out Std_logic);

    ATTRIBUTE Vital_Level0 OF y_3_B : ENTITY IS TRUE;

  end y_3_B;

  architecture Structure of y_3_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal y3_out 	: std_logic := 'X';
  ...
  begin
    y_pad_3: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>y3_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, y3_out)
    VARIABLE y3_zd         	: std_logic := 'X';
    ...
    VitalPathDelay01 (
      OutSignal => y3, OutSignalName => "y3", OutTemp => y3_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_y3,
                           PathCondition => TRUE)),
...
-- entity y_1_B
  ...
  entity y_1_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "y_1_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_y1	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; y1: out Std_logic);

    ATTRIBUTE Vital_Level0 OF y_1_B : ENTITY IS TRUE;

  end y_1_B;

  architecture Structure of y_1_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal y1_out 	: std_logic := 'X';
  ...
  begin
    y_pad_1: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>y1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, y1_out)
    VARIABLE y1_zd         	: std_logic := 'X';
    ...
    VitalPathDelay01 (
      OutSignal => y1, OutSignalName => "y1", OutTemp => y1_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_y1,
                           PathCondition => TRUE)),
...
-- entity SEG_0_B
  ...
  entity SEG_0_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "SEG_0_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_SEG0	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; SEG0: out Std_logic);

    ATTRIBUTE Vital_Level0 OF SEG_0_B : ENTITY IS TRUE;

  end SEG_0_B;

  architecture Structure of SEG_0_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal SEG0_out 	: std_logic := 'X';
  ...
  begin
    SEG_pad_0: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>SEG0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, SEG0_out)
    VARIABLE SEG0_zd         	: std_logic := 'X';
    VARIABLE SEG0_GlitchData 	: VitalGlitchDataType;
    ...
    VitalPathDelay01 (
      OutSignal => SEG0, OutSignalName => "SEG0", OutTemp => SEG0_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_SEG0,
                           PathCondition => TRUE)),
      GlitchData => SEG0_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity SEG_1_B
  ...
  entity SEG_1_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "SEG_1_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_SEG1	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; SEG1: out Std_logic);

    ATTRIBUTE Vital_Level0 OF SEG_1_B : ENTITY IS TRUE;

  end SEG_1_B;

  architecture Structure of SEG_1_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal SEG1_out 	: std_logic := 'X';
  ...
  begin
    SEG_pad_1: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>SEG1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, SEG1_out)
    VARIABLE SEG1_zd         	: std_logic := 'X';
    VARIABLE SEG1_GlitchData 	: VitalGlitchDataType;
    ...
    VitalPathDelay01 (
      OutSignal => SEG1, OutSignalName => "SEG1", OutTemp => SEG1_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_SEG1,
                           PathCondition => TRUE)),
      GlitchData => SEG1_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity SEG_2_B
  ...
  entity SEG_2_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "SEG_2_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_SEG2	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; SEG2: out Std_logic);

    ATTRIBUTE Vital_Level0 OF SEG_2_B : ENTITY IS TRUE;

  end SEG_2_B;

  architecture Structure of SEG_2_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal SEG2_out 	: std_logic := 'X';
  ...
  begin
    SEG_pad_2: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>SEG2_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, SEG2_out)
    VARIABLE SEG2_zd         	: std_logic := 'X';
    VARIABLE SEG2_GlitchData 	: VitalGlitchDataType;
    ...
    VitalPathDelay01 (
      OutSignal => SEG2, OutSignalName => "SEG2", OutTemp => SEG2_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_SEG2,
                           PathCondition => TRUE)),
      GlitchData => SEG2_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity SEG_3_B
  ...
  entity SEG_3_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "SEG_3_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_SEG3	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; SEG3: out Std_logic);

    ATTRIBUTE Vital_Level0 OF SEG_3_B : ENTITY IS TRUE;

  end SEG_3_B;

  architecture Structure of SEG_3_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal SEG3_out 	: std_logic := 'X';
  ...
  begin
    SEG_pad_3: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>SEG3_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, SEG3_out)
    VARIABLE SEG3_zd         	: std_logic := 'X';
    VARIABLE SEG3_GlitchData 	: VitalGlitchDataType;
    ...
    VitalPathDelay01 (
      OutSignal => SEG3, OutSignalName => "SEG3", OutTemp => SEG3_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_SEG3,
                           PathCondition => TRUE)),
      GlitchData => SEG3_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity StopB
  ...
  entity StopB is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "StopB";

      tipd_StopS  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_StopS_PADDI	 : VitalDelayType01 := (0 ns, 0 ns);
      tperiod_StopS 	: VitalDelayType := 0 ns;
      tpw_StopS_posedge	: VitalDelayType := 0 ns;
      tpw_StopS_negedge	: VitalDelayType := 0 ns);

    port (PADDI: out Std_logic; StopS: in Std_logic);

    ATTRIBUTE Vital_Level0 OF StopB : ENTITY IS TRUE;

  end StopB;

  architecture Structure of StopB is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDI_out 	: std_logic := 'X';
    signal StopS_ipd 	: std_logic := 'X';

    component xo2iobuf0038
      port (Z: out Std_logic; PAD: in Std_logic);
    end component;
  begin
    Stop_pad: xo2iobuf0038
      port map (Z=>PADDI_out, PAD=>StopS_ipd);

    --  INPUT PATH DELAYs
    WireDelay : BLOCK
    BEGIN
      VitalWireDelay(StopS_ipd, StopS, tipd_StopS);
    END BLOCK;

    VitalBehavior : PROCESS (PADDI_out, StopS_ipd)
    VARIABLE PADDI_zd         	: std_logic := 'X';
    VARIABLE PADDI_GlitchData 	: VitalGlitchDataType;

    VARIABLE tviol_StopS_StopS          	: x01 := '0';
    VARIABLE periodcheckinfo_StopS	: VitalPeriodDataType;

    BEGIN

    IF (TimingChecksOn) THEN
      VitalPeriodPulseCheck (
        TestSignal => StopS_ipd,
        TestSignalName => "StopS",
        Period => tperiod_StopS,
        PulseWidthHigh => tpw_StopS_posedge,
        PulseWidthLow => tpw_StopS_negedge,
        PeriodData => periodcheckinfo_StopS,
        Violation => tviol_StopS_StopS,
        MsgOn => MsgOn, XOn => XOn,
        HeaderMsg => InstancePath,
        CheckEnabled => TRUE,
        MsgSeverity => warning);
    ...
    VitalPathDelay01 (
      ...
      Paths      => (0 => (InputChangeTime => StopS_ipd'last_event,
                           PathDelay => tpd_StopS_PADDI,
                           PathCondition => TRUE)),
...
-- entity StartB
  ...
  entity StartB is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "StartB";

      tipd_StartS  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_StartS_PADDI	 : VitalDelayType01 := (0 ns, 0 ns);
      tperiod_StartS 	: VitalDelayType := 0 ns;
      tpw_StartS_posedge	: VitalDelayType := 0 ns;
      tpw_StartS_negedge	: VitalDelayType := 0 ns);

    port (PADDI: out Std_logic; StartS: in Std_logic);

    ATTRIBUTE Vital_Level0 OF StartB : ENTITY IS TRUE;

  end StartB;

  architecture Structure of StartB is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDI_out 	: std_logic := 'X';
    signal StartS_ipd 	: std_logic := 'X';

    component xo2iobuf0038
      port (Z: out Std_logic; PAD: in Std_logic);
    end component;
  begin
    Start_pad: xo2iobuf0038
      port map (Z=>PADDI_out, PAD=>StartS_ipd);

    --  INPUT PATH DELAYs
    WireDelay : BLOCK
    BEGIN
      VitalWireDelay(StartS_ipd, StartS, tipd_StartS);
    END BLOCK;

    VitalBehavior : PROCESS (PADDI_out, StartS_ipd)
    VARIABLE PADDI_zd         	: std_logic := 'X';
    VARIABLE PADDI_GlitchData 	: VitalGlitchDataType;

    VARIABLE tviol_StartS_StartS          	: x01 := '0';
    VARIABLE periodcheckinfo_StartS	: VitalPeriodDataType;

    BEGIN

    IF (TimingChecksOn) THEN
      VitalPeriodPulseCheck (
        TestSignal => StartS_ipd,
        TestSignalName => "StartS",
        Period => tperiod_StartS,
        PulseWidthHigh => tpw_StartS_posedge,
        PulseWidthLow => tpw_StartS_negedge,
        PeriodData => periodcheckinfo_StartS,
        Violation => tviol_StartS_StartS,
        MsgOn => MsgOn, XOn => XOn,
        HeaderMsg => InstancePath,
        CheckEnabled => TRUE,
        MsgSeverity => warning);
    ...
    VitalPathDelay01 (
      OutSignal => PADDI, OutSignalName => "PADDI", OutTemp => PADDI_zd,
      Paths      => (0 => (InputChangeTime => StartS_ipd'last_event,
                           PathDelay => tpd_StartS_PADDI,
                           PathCondition => TRUE)),
      GlitchData => PADDI_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity MR_0_B
  ...
  entity MR_0_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "MR_0_B";

      tipd_MR0  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_MR0_PADDI	 : VitalDelayType01 := (0 ns, 0 ns);
      tperiod_MR0 	: VitalDelayType := 0 ns;
      tpw_MR0_posedge	: VitalDelayType := 0 ns;
      tpw_MR0_negedge	: VitalDelayType := 0 ns);

    port (PADDI: out Std_logic; MR0: in Std_logic);

    ATTRIBUTE Vital_Level0 OF MR_0_B : ENTITY IS TRUE;

  end MR_0_B;

  architecture Structure of MR_0_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDI_out 	: std_logic := 'X';
    signal MR0_ipd 	: std_logic := 'X';

    component xo2iobuf0038
      port (Z: out Std_logic; PAD: in Std_logic);
    end component;
  begin
    MR_pad_0: xo2iobuf0038
      port map (Z=>PADDI_out, PAD=>MR0_ipd);

    --  INPUT PATH DELAYs
    WireDelay : BLOCK
    BEGIN
      VitalWireDelay(MR0_ipd, MR0, tipd_MR0);
    END BLOCK;

    VitalBehavior : PROCESS (PADDI_out, MR0_ipd)
    VARIABLE PADDI_zd         	: std_logic := 'X';
    VARIABLE PADDI_GlitchData 	: VitalGlitchDataType;

    VARIABLE tviol_MR0_MR0          	: x01 := '0';
    VARIABLE periodcheckinfo_MR0	: VitalPeriodDataType;
    ...
    IF (TimingChecksOn) THEN
      VitalPeriodPulseCheck (
        ...
        TestSignalName => "MR0",
        Period => tperiod_MR0,
        PulseWidthHigh => tpw_MR0_posedge,
        PulseWidthLow => tpw_MR0_negedge,
        PeriodData => periodcheckinfo_MR0,
        Violation => tviol_MR0_MR0,
        MsgOn => MsgOn, XOn => XOn,
        HeaderMsg => InstancePath,
        CheckEnabled => TRUE,
        MsgSeverity => warning);
    ...
    VitalPathDelay01 (
      OutSignal => PADDI, OutSignalName => "PADDI", OutTemp => PADDI_zd,
      Paths      => (0 => (InputChangeTime => MR0_ipd'last_event,
                           PathDelay => tpd_MR0_PADDI,
                           PathCondition => TRUE)),
      GlitchData => PADDI_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity MR_1_B
  ...
  entity MR_1_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "MR_1_B";

      tipd_MR1  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_MR1_PADDI	 : VitalDelayType01 := (0 ns, 0 ns);
      tperiod_MR1 	: VitalDelayType := 0 ns;
      tpw_MR1_posedge	: VitalDelayType := 0 ns;
      tpw_MR1_negedge	: VitalDelayType := 0 ns);

    port (PADDI: out Std_logic; MR1: in Std_logic);

    ATTRIBUTE Vital_Level0 OF MR_1_B : ENTITY IS TRUE;

  end MR_1_B;

  architecture Structure of MR_1_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDI_out 	: std_logic := 'X';
    signal MR1_ipd 	: std_logic := 'X';

    component xo2iobuf0038
      port (Z: out Std_logic; PAD: in Std_logic);
    end component;
  begin
    MR_pad_1: xo2iobuf0038
      port map (Z=>PADDI_out, PAD=>MR1_ipd);

    --  INPUT PATH DELAYs
    WireDelay : BLOCK
    BEGIN
      VitalWireDelay(MR1_ipd, MR1, tipd_MR1);
    END BLOCK;

    VitalBehavior : PROCESS (PADDI_out, MR1_ipd)
    VARIABLE PADDI_zd         	: std_logic := 'X';
    VARIABLE PADDI_GlitchData 	: VitalGlitchDataType;

    VARIABLE tviol_MR1_MR1          	: x01 := '0';
    VARIABLE periodcheckinfo_MR1	: VitalPeriodDataType;
    ...
    IF (TimingChecksOn) THEN
      VitalPeriodPulseCheck (
        ...
        TestSignalName => "MR1",
        Period => tperiod_MR1,
        PulseWidthHigh => tpw_MR1_posedge,
        PulseWidthLow => tpw_MR1_negedge,
        PeriodData => periodcheckinfo_MR1,
        Violation => tviol_MR1_MR1,
        MsgOn => MsgOn, XOn => XOn,
        HeaderMsg => InstancePath,
        CheckEnabled => TRUE,
        MsgSeverity => warning);
    ...
    VitalPathDelay01 (
      OutSignal => PADDI, OutSignalName => "PADDI", OutTemp => PADDI_zd,
      Paths      => (0 => (InputChangeTime => MR1_ipd'last_event,
                           PathDelay => tpd_MR1_PADDI,
                           PathCondition => TRUE)),
      GlitchData => PADDI_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity y_8_B
  ...
  entity y_8_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "y_8_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_y8	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; y8: out Std_logic);

    ATTRIBUTE Vital_Level0 OF y_8_B : ENTITY IS TRUE;

  end y_8_B;

  architecture Structure of y_8_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal y8_out 	: std_logic := 'X';
  ...
  begin
    y_pad_8: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>y8_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, y8_out)
    VARIABLE y8_zd         	: std_logic := 'X';
    ...
    VitalPathDelay01 (
      OutSignal => y8, OutSignalName => "y8", OutTemp => y8_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_y8,
                           PathCondition => TRUE)),
...
-- entity y_7_B
  ...
  entity y_7_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "y_7_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_y7	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; y7: out Std_logic);

    ATTRIBUTE Vital_Level0 OF y_7_B : ENTITY IS TRUE;

  end y_7_B;

  architecture Structure of y_7_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal y7_out 	: std_logic := 'X';
  ...
  begin
    y_pad_7: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>y7_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, y7_out)
    VARIABLE y7_zd         	: std_logic := 'X';
    ...
    VitalPathDelay01 (
      OutSignal => y7, OutSignalName => "y7", OutTemp => y7_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_y7,
                           PathCondition => TRUE)),
...
-- entity y_6_B
  ...
  entity y_6_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "y_6_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_y6	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; y6: out Std_logic);

    ATTRIBUTE Vital_Level0 OF y_6_B : ENTITY IS TRUE;

  end y_6_B;

  architecture Structure of y_6_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal y6_out 	: std_logic := 'X';
  ...
  begin
    y_pad_6: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>y6_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, y6_out)
    VARIABLE y6_zd         	: std_logic := 'X';
    ...
    VitalPathDelay01 (
      OutSignal => y6, OutSignalName => "y6", OutTemp => y6_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_y6,
                           PathCondition => TRUE)),
...
-- entity y_5_B
  ...
  entity y_5_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "y_5_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_y5	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; y5: out Std_logic);

    ATTRIBUTE Vital_Level0 OF y_5_B : ENTITY IS TRUE;

  end y_5_B;

  architecture Structure of y_5_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal y5_out 	: std_logic := 'X';
  ...
  begin
    y_pad_5: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>y5_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, y5_out)
    VARIABLE y5_zd         	: std_logic := 'X';
    ...
    VitalPathDelay01 (
      OutSignal => y5, OutSignalName => "y5", OutTemp => y5_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_y5,
                           PathCondition => TRUE)),
...
-- entity y_4_B
  ...
  entity y_4_B is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "y_4_B";

      tipd_PADDO  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_PADDO_y4	 : VitalDelayType01 := (0 ns, 0 ns));

    port (PADDO: in Std_logic; y4: out Std_logic);

    ATTRIBUTE Vital_Level0 OF y_4_B : ENTITY IS TRUE;

  end y_4_B;

  architecture Structure of y_4_B is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDO_ipd 	: std_logic := 'X';
    signal y4_out 	: std_logic := 'X';
  ...
  begin
    y_pad_4: xo2iobuf
      port map (I=>PADDO_ipd, T=>GNDI, PAD=>y4_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    ...
    VitalBehavior : PROCESS (PADDO_ipd, y4_out)
    VARIABLE y4_zd         	: std_logic := 'X';
    ...
    VitalPathDelay01 (
      OutSignal => y4, OutSignalName => "y4", OutTemp => y4_zd,
      Paths      => (0 => (InputChangeTime => PADDO_ipd'last_event,
                           PathDelay => tpd_PADDO_y4,
                           PathCondition => TRUE)),
...
-- entity I6_OscInst0
  ...
  entity I6_OscInst0 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "I6_OscInst0");

    port (OSC: out Std_logic);

    ATTRIBUTE Vital_Level0 OF I6_OscInst0 : ENTITY IS TRUE;

  end I6_OscInst0;

  architecture Structure of I6_OscInst0 is
...
-- entity I6_CTInst0_EFBInst_0
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity I6_CTInst0_EFBInst_0 is
    port (TCOC: out Std_logic; TCRSTN: in Std_logic; TCCLKI: in Std_logic);



  end I6_CTInst0_EFBInst_0;

  architecture Structure of I6_CTInst0_EFBInst_0 is
    signal GNDI: Std_logic;
    signal VCCI: Std_logic;
    component vcc
      port (PWR1: out Std_logic);
...
-- entity Stoppuhr
  ...
  entity Stoppuhr is
    port (D15: out Std_logic; MR: in Std_logic_vector (1 downto 0); 
          PR: in Std_logic; RES: in Std_logic; 
          SEG: out Std_logic_vector (3 downto 0); Start: in Std_logic; 
          Stop: in Std_logic; y: out Std_logic_vector (1 to 8));
  ...
  architecture Structure of Stoppuhr is
    signal I7_dec_cnt_16: Std_logic;
    signal I7_dec_cnt_15: Std_logic;
    signal I7_n150: Std_logic;
    signal I7_n151: Std_logic;
    signal I7_n1022: Std_logic;
    signal N_2: Std_logic;
    signal I7_n2080: Std_logic;
    signal I7_n2081: Std_logic;
    signal I7_dec_cnt_20: Std_logic;
    signal I7_dec_cnt_19: Std_logic;
    signal I7_n146: Std_logic;
    signal I7_n147: Std_logic;
    signal I7_n2082: Std_logic;
    signal I7_n2083: Std_logic;
    signal I7_dec_cnt_10: Std_logic;
    signal I7_dec_cnt_9: Std_logic;
    signal I7_n156: Std_logic;
    signal I7_n157: Std_logic;
    signal I7_n2077: Std_logic;
    signal I7_n2078: Std_logic;
    signal I7_dec_cnt_8: Std_logic;
    signal I7_dec_cnt_7: Std_logic;
    signal I7_n158: Std_logic;
    signal I7_n159: Std_logic;
    signal I7_n2076: Std_logic;
    signal I7_dec_cnt_31: Std_logic;
    signal I7_n135: Std_logic;
    signal I7_n2088: Std_logic;
    signal I7_dec_cnt_30: Std_logic;
    signal I7_dec_cnt_29: Std_logic;
    signal I7_n136: Std_logic;
    signal I7_n137: Std_logic;
    signal I7_n2087: Std_logic;
    signal I7_dec_cnt_28: Std_logic;
    signal I7_dec_cnt_27: Std_logic;
    signal I7_n138: Std_logic;
    signal I7_n139: Std_logic;
    signal I7_n2086: Std_logic;
    signal I7_dec_cnt_26: Std_logic;
    signal I7_dec_cnt_25: Std_logic;
    signal I7_n140: Std_logic;
    signal I7_n141: Std_logic;
    signal I7_n2085: Std_logic;
    signal I7_dec_cnt_6: Std_logic;
    signal I7_dec_cnt_5: Std_logic;
    signal I7_n160: Std_logic;
    signal I7_n161: Std_logic;
    signal I7_n2075: Std_logic;
    signal I7_dec_cnt_24: Std_logic;
    signal I7_dec_cnt_23: Std_logic;
    signal I7_n142: Std_logic;
    signal I7_n143: Std_logic;
    signal I7_n2084: Std_logic;
    signal I7_dec_cnt_14: Std_logic;
    signal I7_dec_cnt_13: Std_logic;
    signal I7_n152: Std_logic;
    signal I7_n153: Std_logic;
    signal I7_n2079: Std_logic;
    signal I7_dec_cnt_4: Std_logic;
    signal I7_dec_cnt_3: Std_logic;
    signal I7_n162: Std_logic;
    signal I7_n163: Std_logic;
    signal I7_n2074: Std_logic;
    signal I7_dec_cnt_12: Std_logic;
    signal I7_dec_cnt_11: Std_logic;
    signal I7_n154: Std_logic;
    signal I7_n155: Std_logic;
    signal I7_dec_cnt_18: Std_logic;
    signal I7_dec_cnt_17: Std_logic;
    signal I7_n148: Std_logic;
    signal I7_n149: Std_logic;
    signal I7_dec_cnt_22: Std_logic;
    signal I7_dec_cnt_21: Std_logic;
    signal I7_n144: Std_logic;
    signal I7_n145: Std_logic;
    signal I7_dec_cnt_2: Std_logic;
    signal dec_cnt_1: Std_logic;
    signal I7_n164: Std_logic;
    signal I7_n165: Std_logic;
    signal I7_n2073: Std_logic;
    signal I7_dec_cnt_0: Std_logic;
    signal I7_n166: Std_logic;
    signal I2_cnt_3: Std_logic;
    signal cnt_2_adj_17: Std_logic;
    signal I2_cnt_0_adj_9: Std_logic;
    signal I2_cnt_1: Std_logic;
    signal I2_n23: Std_logic;
    signal I2_n25: Std_logic;
    signal N_8: Std_logic;
    signal I2_n1173: Std_logic;
    signal N_4: Std_logic;
    signal I2_n26: Std_logic;
    signal I6_Clk100Hz: Std_logic;
    signal I6_n71: Std_logic;
    signal I6_n1021: Std_logic;
    signal I6_Counter_Clk1Hz: Std_logic;
    signal I6_n523: Std_logic;
    signal I6_n1023: Std_logic;
    signal I6_Counter_Clk3Hz: Std_logic;
    signal I6_n521: Std_logic;
    signal I6_Counter_Counter1Hz_2: Std_logic;
    signal I6_Counter_Counter1Hz_3: Std_logic;
    signal I6_n7: Std_logic;
    signal I6_n6: Std_logic;
    signal I6_n38: Std_logic;
    signal I6_n39: Std_logic;
    signal I6_Counter_Counter1Hz_5: Std_logic;
    signal I6_Counter_Counter1Hz_4: Std_logic;
    signal I6_n2483: Std_logic;
    signal I6_n2489: Std_logic;
    signal I6_n36_adj_3: Std_logic;
    signal I6_n37: Std_logic;
    signal I6_n2481: Std_logic;
    signal I6_Counter_Counter1Hz_6: Std_logic;
    signal I6_n35_adj_2: Std_logic;
    signal I6_Counter_Counter3Hz_2: Std_logic;
    signal I6_n6_adj_1: Std_logic;
    signal I6_Counter_Counter3Hz_1: Std_logic;
    signal I6_n1: Std_logic;
    signal I6_n35: Std_logic;
    signal I6_Counter_Counter3Hz_3: Std_logic;
    signal I6_Counter_Counter3Hz_4: Std_logic;
    signal I6_n2487: Std_logic;
    signal I6_n32: Std_logic;
    signal I6_n33: Std_logic;
    signal I6_Counter_Counter3Hz_5: Std_logic;
    signal I6_n2482: Std_logic;
    signal I6_n31: Std_logic;
    signal I6_n41: Std_logic;
    signal I6_n40: Std_logic;
    signal I6_n36: Std_logic;
    signal I2_n19: Std_logic;
    signal n628: Std_logic;
    signal N_3: Std_logic;
    signal I3_n19: Std_logic;
    signal cnt_1_adj_20: Std_logic;
    signal cnt_0_adj_21: Std_logic;
    signal cnt_3_adj_18: Std_logic;
    signal cnt_2_adj_19: Std_logic;
    signal N_5: Std_logic;
    signal I3_n1029: Std_logic;
    signal I4_n19: Std_logic;
    signal cnt_1_adj_24: Std_logic;
    signal cnt_0_adj_25: Std_logic;
    signal cnt_3_adj_22: Std_logic;
    signal cnt_2_adj_23: Std_logic;
    signal D15_c: Std_logic;
    signal I4_n1026: Std_logic;
    signal n2539: Std_logic;
    signal N_10: Std_logic;
    signal Start_c: Std_logic;
    signal cnt_0: Std_logic;
    signal cnt_1: Std_logic;
    signal I1_n25: Std_logic;
    signal I1_n26: Std_logic;
    signal I1_n1036: Std_logic;
    signal cnt_3: Std_logic;
    signal cnt_2: Std_logic;
    signal I1_n23: Std_logic;
    signal I1_n24: Std_logic;
    signal I3_n26: Std_logic;
    signal I4_n26: Std_logic;
    signal I3_n25: Std_logic;
    signal I4_n25: Std_logic;
    signal I2_n24: Std_logic;
    signal I3_n24: Std_logic;
    signal VCC_net: Std_logic;
    signal I4_n24: Std_logic;
    signal I7_n50: Std_logic;
    signal I3_n23: Std_logic;
    signal I7_n32: Std_logic;
    signal I4_n23: Std_logic;
    signal I7_n43: Std_logic;
    signal n2486: Std_logic;
    signal n2273: Std_logic;
    signal n2276: Std_logic;
    signal n2282: Std_logic;
    signal RES_c: Std_logic;
    signal I7_n300: Std_logic;
    signal I7_n2267: Std_logic;
    signal MR_c_0: Std_logic;
    signal PR_c: Std_logic;
    signal MR_c_1: Std_logic;
    signal I7_n2480: Std_logic;
    signal I7_s_1: Std_logic;
    signal I7_s_2: Std_logic;
    signal I7_s_0: Std_logic;
    signal I7_s_3: Std_logic;
    signal n516: Std_logic;
    signal n517: Std_logic;
    signal n513: Std_logic;
    signal n519: Std_logic;
    signal I2_n2484: Std_logic;
    signal n4: Std_logic;
    signal I7_n36: Std_logic;
    signal I7_n48: Std_logic;
    signal I7_n54: Std_logic;
    signal I7_n35: Std_logic;
    signal I7_n56: Std_logic;
    signal I7_n44: Std_logic;
    signal I7_n52: Std_logic;
    signal I7_n2205: Std_logic;
    signal I7_n46: Std_logic;
    signal SEG_c: Std_logic;
    signal I7_n2485: Std_logic;
    signal n511: Std_logic;
    signal n512: Std_logic;
    signal I7_n239: Std_logic;
    signal I7_n40: Std_logic;
    signal I6_n4: Std_logic;
    signal I6_n6_adj_4: Std_logic;
    ...
    signal I6_ClkOsc: Std_logic;
    component I7_SLICE_0
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_1
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_2
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_3
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_4
      port (A0: in Std_logic; DI0: in Std_logic; LSR: in Std_logic; 
            CLK: in Std_logic; FCI: in Std_logic; F0: out Std_logic; 
            Q0: out Std_logic);
    end component;
    component I7_SLICE_5
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_6
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_7
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_8
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_9
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_10
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_11
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_12
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_13
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_14
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_15
      port (A1: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            FCI: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic; FCO: out Std_logic);
    end component;
    component I7_SLICE_16
      port (A1: in Std_logic; DI1: in Std_logic; LSR: in Std_logic; 
            CLK: in Std_logic; F1: out Std_logic; Q1: out Std_logic; 
            FCO: out Std_logic);
    end component;
    component I2_SLICE_17
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            DI1: in Std_logic; DI0: in Std_logic; CE: in Std_logic; 
            LSR: in Std_logic; CLK: in Std_logic; F0: out Std_logic; 
    ...
    component I2_SLICE_18
      port (A0: in Std_logic; DI0: in Std_logic; CE: in Std_logic; 
            LSR: in Std_logic; CLK: in Std_logic; F0: out Std_logic; 
            Q0: out Std_logic);
    end component;
    component I6_SLICE_19
      port (A0: in Std_logic; DI0: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic);
    end component;
    component I6_SLICE_20
      port (B0: in Std_logic; A0: in Std_logic; DI0: in Std_logic; 
            CLK: in Std_logic; F0: out Std_logic; Q0: out Std_logic);
    end component;
    component I6_SLICE_21
      port (B0: in Std_logic; A0: in Std_logic; DI0: in Std_logic; 
            CLK: in Std_logic; F0: out Std_logic; Q0: out Std_logic);
    end component;
    component I6_SLICE_22
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; C0: in Std_logic; B0: in Std_logic; 
            A0: in Std_logic; DI1: in Std_logic; DI0: in Std_logic; 
            LSR: in Std_logic; CLK: in Std_logic; F0: out Std_logic; 
    ...
    component I6_SLICE_24
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic; F1: out Std_logic);
    end component;
    component I6_SLICE_25
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            B0: in Std_logic; A0: in Std_logic; DI1: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic; F1: out Std_logic; 
    ...
    component I6_SLICE_28
      port (A1: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            DI1: in Std_logic; DI0: in Std_logic; LSR: in Std_logic; 
            CLK: in Std_logic; F0: out Std_logic; Q0: out Std_logic; 
            F1: out Std_logic; Q1: out Std_logic);
    end component;
    component I6_SLICE_29
      port (B1: in Std_logic; A1: in Std_logic; A0: in Std_logic; 
            DI0: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic; F1: out Std_logic);
    end component;
    component I2_SLICE_30
      port (D0: in Std_logic; C0: in Std_logic; B0: in Std_logic; 
            A0: in Std_logic; DI0: in Std_logic; CE: in Std_logic; 
            CLK: in Std_logic; F0: out Std_logic; Q0: out Std_logic);
    end component;
    component I3_SLICE_31
      port (B1: in Std_logic; A1: in Std_logic; D0: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            DI0: in Std_logic; CE: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic; F1: out Std_logic);
    end component;
    component I4_SLICE_32
      port (B1: in Std_logic; A1: in Std_logic; D0: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            DI0: in Std_logic; CE: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic; F1: out Std_logic);
    ...
    component I1_SLICE_34
      port (B1: in Std_logic; A1: in Std_logic; A0: in Std_logic; 
            DI1: in Std_logic; DI0: in Std_logic; CE: in Std_logic; 
            LSR: in Std_logic; CLK: in Std_logic; F0: out Std_logic; 
            Q0: out Std_logic; F1: out Std_logic; Q1: out Std_logic);
    end component;
    component I1_SLICE_35
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; C0: in Std_logic; B0: in Std_logic; 
            A0: in Std_logic; DI1: in Std_logic; DI0: in Std_logic; 
            CE: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
    ...
    component I3_SLICE_36
      port (A0: in Std_logic; DI0: in Std_logic; CE: in Std_logic; 
            LSR: in Std_logic; CLK: in Std_logic; F0: out Std_logic; 
            Q0: out Std_logic);
    end component;
    component I4_SLICE_37
      port (A0: in Std_logic; DI0: in Std_logic; CE: in Std_logic; 
            LSR: in Std_logic; CLK: in Std_logic; F0: out Std_logic; 
            Q0: out Std_logic);
    end component;
    component I3_SLICE_38
      port (B0: in Std_logic; A0: in Std_logic; DI0: in Std_logic; 
            CE: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic);
    end component;
    component I4_SLICE_39
      port (B0: in Std_logic; A0: in Std_logic; DI0: in Std_logic; 
            CE: in Std_logic; LSR: in Std_logic; CLK: in Std_logic; 
            F0: out Std_logic; Q0: out Std_logic);
    end component;
    component I2_SLICE_40
      port (C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            DI0: in Std_logic; CE: in Std_logic; LSR: in Std_logic; 
            CLK: in Std_logic; F0: out Std_logic; Q0: out Std_logic);
    end component;
    ...
    component I2_i1934_SLICE_45
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            M0: in Std_logic; OFX0: out Std_logic);
    end component;
    component I2_i1937_SLICE_46
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            M0: in Std_logic; OFX0: out Std_logic);
    end component;
    component I2_i1943_SLICE_47
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            M0: in Std_logic; OFX0: out Std_logic);
    end component;
    component I7_i1928_SLICE_48
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; D0: in Std_logic; C0: in Std_logic; 
            B0: in Std_logic; A0: in Std_logic; M0: in Std_logic; 
            OFX0: out Std_logic);
    end component;
    component I6_i1940_SLICE_49
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            M0: in Std_logic; OFX0: out Std_logic);
    end component;
    component I7_SLICE_50
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; D0: in Std_logic; C0: in Std_logic; 
            B0: in Std_logic; A0: in Std_logic; F0: out Std_logic; 
            F1: out Std_logic);
    end component;
    component I7_SLICE_51
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; D0: in Std_logic; C0: in Std_logic; 
            B0: in Std_logic; A0: in Std_logic; F0: out Std_logic; 
            F1: out Std_logic);
    end component;
    component I7_SLICE_52
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; D0: in Std_logic; C0: in Std_logic; 
            B0: in Std_logic; A0: in Std_logic; F0: out Std_logic; 
            F1: out Std_logic);
    end component;
    component I7_SLICE_53
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; D0: in Std_logic; C0: in Std_logic; 
            B0: in Std_logic; A0: in Std_logic; F0: out Std_logic; 
            F1: out Std_logic);
    end component;
    component I2_SLICE_54
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    ...
    component I7_SLICE_56
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    component I7_SLICE_57
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; C0: in Std_logic; B0: in Std_logic; 
            A0: in Std_logic; F0: out Std_logic; F1: out Std_logic);
    end component;
    component I7_SLICE_58
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; D0: in Std_logic; C0: in Std_logic; 
            B0: in Std_logic; A0: in Std_logic; F0: out Std_logic; 
            F1: out Std_logic);
    end component;
    component I7_SLICE_59
      port (B1: in Std_logic; A1: in Std_logic; D0: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    component I7_SLICE_60
      port (B1: in Std_logic; A1: in Std_logic; D0: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    component I7_SLICE_61
      port (B1: in Std_logic; A1: in Std_logic; D0: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    component I7_SLICE_62
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    component I6_SLICE_63
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    component I6_SLICE_64
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    component I6_SLICE_65
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    component I7_SLICE_66
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; D0: in Std_logic; C0: in Std_logic; 
            B0: in Std_logic; A0: in Std_logic; F0: out Std_logic; 
            F1: out Std_logic);
    end component;
    component I7_SLICE_67
      port (D1: in Std_logic; C1: in Std_logic; B1: in Std_logic; 
            A1: in Std_logic; D0: in Std_logic; C0: in Std_logic; 
            B0: in Std_logic; A0: in Std_logic; F0: out Std_logic; 
            F1: out Std_logic);
    ...
    component I7_SLICE_69
      port (B1: in Std_logic; A1: in Std_logic; D0: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    component I7_SLICE_70
      port (B1: in Std_logic; A1: in Std_logic; D0: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    component I7_SLICE_71
      port (B1: in Std_logic; A1: in Std_logic; D0: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            F0: out Std_logic; F1: out Std_logic);
    end component;
    ...
    component I6_OscInst0
      port (OSC: out Std_logic);
    end component;
    component I6_CTInst0_EFBInst_0
      port (TCOC: out Std_logic; TCRSTN: in Std_logic; TCCLKI: in Std_logic);
    end component;
  begin
    I7_SLICE_0I: I7_SLICE_0
      port map (A1=>I7_dec_cnt_16, A0=>I7_dec_cnt_15, DI1=>I7_n150, 
                DI0=>I7_n151, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2080, 
                F0=>I7_n151, Q0=>I7_dec_cnt_15, F1=>I7_n150, Q1=>I7_dec_cnt_16, 
                FCO=>I7_n2081);
    I7_SLICE_1I: I7_SLICE_1
      port map (A1=>I7_dec_cnt_20, A0=>I7_dec_cnt_19, DI1=>I7_n146, 
                DI0=>I7_n147, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2082, 
                F0=>I7_n147, Q0=>I7_dec_cnt_19, F1=>I7_n146, Q1=>I7_dec_cnt_20, 
                FCO=>I7_n2083);
    I7_SLICE_2I: I7_SLICE_2
      port map (A1=>I7_dec_cnt_10, A0=>I7_dec_cnt_9, DI1=>I7_n156, 
                DI0=>I7_n157, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2077, 
                F0=>I7_n157, Q0=>I7_dec_cnt_9, F1=>I7_n156, Q1=>I7_dec_cnt_10, 
                FCO=>I7_n2078);
    I7_SLICE_3I: I7_SLICE_3
      port map (A1=>I7_dec_cnt_8, A0=>I7_dec_cnt_7, DI1=>I7_n158, DI0=>I7_n159, 
                LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2076, F0=>I7_n159, 
                Q0=>I7_dec_cnt_7, F1=>I7_n158, Q1=>I7_dec_cnt_8, FCO=>I7_n2077);
    I7_SLICE_4I: I7_SLICE_4
      port map (A0=>I7_dec_cnt_31, DI0=>I7_n135, LSR=>I7_n1022, CLK=>N_2, 
                FCI=>I7_n2088, F0=>I7_n135, Q0=>I7_dec_cnt_31);
    I7_SLICE_5I: I7_SLICE_5
      port map (A1=>I7_dec_cnt_30, A0=>I7_dec_cnt_29, DI1=>I7_n136, 
                DI0=>I7_n137, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2087, 
                F0=>I7_n137, Q0=>I7_dec_cnt_29, F1=>I7_n136, Q1=>I7_dec_cnt_30, 
                FCO=>I7_n2088);
    I7_SLICE_6I: I7_SLICE_6
      port map (A1=>I7_dec_cnt_28, A0=>I7_dec_cnt_27, DI1=>I7_n138, 
                DI0=>I7_n139, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2086, 
                F0=>I7_n139, Q0=>I7_dec_cnt_27, F1=>I7_n138, Q1=>I7_dec_cnt_28, 
                FCO=>I7_n2087);
    I7_SLICE_7I: I7_SLICE_7
      port map (A1=>I7_dec_cnt_26, A0=>I7_dec_cnt_25, DI1=>I7_n140, 
                DI0=>I7_n141, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2085, 
                F0=>I7_n141, Q0=>I7_dec_cnt_25, F1=>I7_n140, Q1=>I7_dec_cnt_26, 
                FCO=>I7_n2086);
    I7_SLICE_8I: I7_SLICE_8
      port map (A1=>I7_dec_cnt_6, A0=>I7_dec_cnt_5, DI1=>I7_n160, DI0=>I7_n161, 
                LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2075, F0=>I7_n161, 
                Q0=>I7_dec_cnt_5, F1=>I7_n160, Q1=>I7_dec_cnt_6, FCO=>I7_n2076);
    I7_SLICE_9I: I7_SLICE_9
      port map (A1=>I7_dec_cnt_24, A0=>I7_dec_cnt_23, DI1=>I7_n142, 
                DI0=>I7_n143, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2084, 
                F0=>I7_n143, Q0=>I7_dec_cnt_23, F1=>I7_n142, Q1=>I7_dec_cnt_24, 
                FCO=>I7_n2085);
    I7_SLICE_10I: I7_SLICE_10
      port map (A1=>I7_dec_cnt_14, A0=>I7_dec_cnt_13, DI1=>I7_n152, 
                DI0=>I7_n153, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2079, 
                F0=>I7_n153, Q0=>I7_dec_cnt_13, F1=>I7_n152, Q1=>I7_dec_cnt_14, 
                FCO=>I7_n2080);
    I7_SLICE_11I: I7_SLICE_11
      port map (A1=>I7_dec_cnt_4, A0=>I7_dec_cnt_3, DI1=>I7_n162, DI0=>I7_n163, 
                LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2074, F0=>I7_n163, 
                Q0=>I7_dec_cnt_3, F1=>I7_n162, Q1=>I7_dec_cnt_4, FCO=>I7_n2075);
    I7_SLICE_12I: I7_SLICE_12
      port map (A1=>I7_dec_cnt_12, A0=>I7_dec_cnt_11, DI1=>I7_n154, 
                DI0=>I7_n155, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2078, 
                F0=>I7_n155, Q0=>I7_dec_cnt_11, F1=>I7_n154, Q1=>I7_dec_cnt_12, 
                FCO=>I7_n2079);
    I7_SLICE_13I: I7_SLICE_13
      port map (A1=>I7_dec_cnt_18, A0=>I7_dec_cnt_17, DI1=>I7_n148, 
                DI0=>I7_n149, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2081, 
                F0=>I7_n149, Q0=>I7_dec_cnt_17, F1=>I7_n148, Q1=>I7_dec_cnt_18, 
                FCO=>I7_n2082);
    I7_SLICE_14I: I7_SLICE_14
      port map (A1=>I7_dec_cnt_22, A0=>I7_dec_cnt_21, DI1=>I7_n144, 
                DI0=>I7_n145, LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2083, 
                F0=>I7_n145, Q0=>I7_dec_cnt_21, F1=>I7_n144, Q1=>I7_dec_cnt_22, 
                FCO=>I7_n2084);
    I7_SLICE_15I: I7_SLICE_15
      port map (A1=>I7_dec_cnt_2, A0=>dec_cnt_1, DI1=>I7_n164, DI0=>I7_n165, 
                LSR=>I7_n1022, CLK=>N_2, FCI=>I7_n2073, F0=>I7_n165, 
                Q0=>dec_cnt_1, F1=>I7_n164, Q1=>I7_dec_cnt_2, FCO=>I7_n2074);
    I7_SLICE_16I: I7_SLICE_16
      port map (A1=>I7_dec_cnt_0, DI1=>I7_n166, LSR=>I7_n1022, CLK=>N_2, 
                F1=>I7_n166, Q1=>I7_dec_cnt_0, FCO=>I7_n2073);
    I2_SLICE_17I: I2_SLICE_17
      port map (D1=>I2_cnt_3, C1=>cnt_2_adj_17, B1=>I2_cnt_0_adj_9, 
                A1=>I2_cnt_1, B0=>I2_cnt_0_adj_9, A0=>I2_cnt_1, DI1=>I2_n23, 
                DI0=>I2_n25, CE=>N_8, LSR=>I2_n1173, CLK=>N_4, F0=>I2_n25, 
                Q0=>I2_cnt_1, F1=>I2_n23, Q1=>I2_cnt_3);
    I2_SLICE_18I: I2_SLICE_18
      port map (A0=>I2_cnt_0_adj_9, DI0=>I2_n26, CE=>N_8, LSR=>I2_n1173, 
                CLK=>N_4, F0=>I2_n26, Q0=>I2_cnt_0_adj_9);
    I6_SLICE_19I: I6_SLICE_19
      port map (A0=>I6_Clk100Hz, DI0=>I6_n71, CLK=>N_2, F0=>I6_n71, 
                Q0=>I6_Clk100Hz);
    I6_SLICE_20I: I6_SLICE_20
      port map (B0=>I6_n1021, A0=>I6_Counter_Clk1Hz, DI0=>I6_n523, CLK=>N_2, 
                F0=>I6_n523, Q0=>I6_Counter_Clk1Hz);
    I6_SLICE_21I: I6_SLICE_21
      port map (B0=>I6_n1023, A0=>I6_Counter_Clk3Hz, DI0=>I6_n521, CLK=>N_2, 
                F0=>I6_n521, Q0=>I6_Counter_Clk3Hz);
    I6_SLICE_22I: I6_SLICE_22
      port map (D1=>I6_Counter_Counter1Hz_2, C1=>I6_Counter_Counter1Hz_3, 
                B1=>I6_n7, A1=>I6_n6, C0=>I6_Counter_Counter1Hz_2, B0=>I6_n7, 
                A0=>I6_n6, DI1=>I6_n38, DI0=>I6_n39, LSR=>I6_n1021, CLK=>N_2, 
                F0=>I6_n39, Q0=>I6_Counter_Counter1Hz_2, F1=>I6_n38, 
                Q1=>I6_Counter_Counter1Hz_3);
    I6_SLICE_23I: I6_SLICE_23
      port map (D1=>I6_Counter_Counter1Hz_5, C1=>I6_Counter_Counter1Hz_4, 
                B1=>I6_n2483, A1=>I6_Counter_Counter1Hz_3, 
                D0=>I6_Counter_Counter1Hz_3, C0=>I6_Counter_Counter1Hz_4, 
                B0=>I6_n2489, A0=>I6_Counter_Counter1Hz_2, DI1=>I6_n36_adj_3, 
                DI0=>I6_n37, LSR=>I6_n1021, CLK=>N_2, F0=>I6_n37, 
                Q0=>I6_Counter_Counter1Hz_4, F1=>I6_n36_adj_3, 
                Q1=>I6_Counter_Counter1Hz_5);
    I6_SLICE_24I: I6_SLICE_24
      port map (C1=>I6_Counter_Counter1Hz_2, B1=>I6_n7, A1=>I6_n6, 
                C0=>I6_n2481, B0=>I6_Counter_Counter1Hz_5, 
                A0=>I6_Counter_Counter1Hz_6, DI0=>I6_n35_adj_2, LSR=>I6_n1021, 
                CLK=>N_2, F0=>I6_n35_adj_2, Q0=>I6_Counter_Counter1Hz_6, 
                F1=>I6_n2483);
    I6_SLICE_25I: I6_SLICE_25
      port map (C1=>I6_Counter_Counter3Hz_2, B1=>I6_n6_adj_1, 
                A1=>I6_Counter_Counter3Hz_1, B0=>I6_n6_adj_1, 
                A0=>I6_Counter_Counter3Hz_1, DI1=>I6_n1, DI0=>I6_n35, 
                LSR=>I6_n1023, CLK=>N_2, F0=>I6_n35, 
                Q0=>I6_Counter_Counter3Hz_1, F1=>I6_n1, 
                Q1=>I6_Counter_Counter3Hz_2);
    I6_SLICE_26I: I6_SLICE_26
      port map (D1=>I6_Counter_Counter3Hz_3, C1=>I6_Counter_Counter3Hz_4, 
                B1=>I6_n2487, A1=>I6_Counter_Counter3Hz_2, 
                D0=>I6_Counter_Counter3Hz_2, C0=>I6_Counter_Counter3Hz_3, 
                B0=>I6_n6_adj_1, A0=>I6_Counter_Counter3Hz_1, DI1=>I6_n32, 
                DI0=>I6_n33, LSR=>I6_n1023, CLK=>N_2, F0=>I6_n33, 
                Q0=>I6_Counter_Counter3Hz_3, F1=>I6_n32, 
                Q1=>I6_Counter_Counter3Hz_4);
    I6_SLICE_27I: I6_SLICE_27
      port map (C1=>I6_Counter_Counter3Hz_2, B1=>I6_n6_adj_1, 
                A1=>I6_Counter_Counter3Hz_1, D0=>I6_Counter_Counter3Hz_5, 
                C0=>I6_Counter_Counter3Hz_4, B0=>I6_n2482, 
                A0=>I6_Counter_Counter3Hz_3, DI0=>I6_n31, LSR=>I6_n1023, 
                CLK=>N_2, F0=>I6_n31, Q0=>I6_Counter_Counter3Hz_5, 
                F1=>I6_n2482);
    I6_SLICE_28I: I6_SLICE_28
      port map (A1=>I6_n7, B0=>I6_n7, A0=>I6_n6, DI1=>I6_n41, DI0=>I6_n40, 
                LSR=>I6_n1021, CLK=>N_2, F0=>I6_n40, Q0=>I6_n6, F1=>I6_n41, 
                Q1=>I6_n7);
    I6_SLICE_29I: I6_SLICE_29
      port map (B1=>I6_n6_adj_1, A1=>I6_Counter_Counter3Hz_1, A0=>I6_n6_adj_1, 
                DI0=>I6_n36, LSR=>I6_n1023, CLK=>N_2, F0=>I6_n36, 
                Q0=>I6_n6_adj_1, F1=>I6_n2487);
    I2_SLICE_30I: I2_SLICE_30
      port map (D0=>I2_cnt_3, C0=>I2_cnt_0_adj_9, B0=>I2_cnt_1, 
                A0=>cnt_2_adj_17, DI0=>I2_n19, CE=>n628, CLK=>N_4, F0=>I2_n19, 
                Q0=>N_3);
    I3_SLICE_31I: I3_SLICE_31
      port map (B1=>I3_n19, A1=>N_8, D0=>cnt_1_adj_20, C0=>cnt_0_adj_21, 
                B0=>cnt_3_adj_18, A0=>cnt_2_adj_19, DI0=>I3_n19, CE=>n628, 
                CLK=>N_5, F0=>I3_n19, Q0=>N_4, F1=>I3_n1029);
    I4_SLICE_32I: I4_SLICE_32
      port map (B1=>I4_n19, A1=>N_8, D0=>cnt_1_adj_24, C0=>cnt_0_adj_25, 
                B0=>cnt_3_adj_22, A0=>cnt_2_adj_23, DI0=>I4_n19, CE=>n628, 
                CLK=>D15_c, F0=>I4_n19, Q0=>N_5, F1=>I4_n1026);
    SLICE_33I: SLICE_33
      port map (DI0=>n2539, LSR=>N_10, CLK=>Start_c, F0=>n2539, Q0=>N_8);
    I1_SLICE_34I: I1_SLICE_34
      port map (B1=>cnt_0, A1=>cnt_1, A0=>cnt_0, DI1=>I1_n25, DI0=>I1_n26, 
                CE=>N_8, LSR=>I1_n1036, CLK=>N_3, F0=>I1_n26, Q0=>cnt_0, 
                F1=>I1_n25, Q1=>cnt_1);
    I1_SLICE_35I: I1_SLICE_35
      port map (D1=>cnt_3, C1=>cnt_2, B1=>cnt_0, A1=>cnt_1, C0=>cnt_2, 
                B0=>cnt_0, A0=>cnt_1, DI1=>I1_n23, DI0=>I1_n24, CE=>N_8, 
                LSR=>I1_n1036, CLK=>N_3, F0=>I1_n24, Q0=>cnt_2, F1=>I1_n23, 
                Q1=>cnt_3);
    I3_SLICE_36I: I3_SLICE_36
      port map (A0=>cnt_0_adj_21, DI0=>I3_n26, CE=>N_8, LSR=>I3_n1029, 
                CLK=>N_5, F0=>I3_n26, Q0=>cnt_0_adj_21);
    I4_SLICE_37I: I4_SLICE_37
      port map (A0=>cnt_0_adj_25, DI0=>I4_n26, CE=>N_8, LSR=>I4_n1026, 
                CLK=>D15_c, F0=>I4_n26, Q0=>cnt_0_adj_25);
    I3_SLICE_38I: I3_SLICE_38
      port map (B0=>cnt_0_adj_21, A0=>cnt_1_adj_20, DI0=>I3_n25, CE=>N_8, 
                LSR=>I3_n1029, CLK=>N_5, F0=>I3_n25, Q0=>cnt_1_adj_20);
    I4_SLICE_39I: I4_SLICE_39
      port map (B0=>cnt_0_adj_25, A0=>cnt_1_adj_24, DI0=>I4_n25, CE=>N_8, 
                LSR=>I4_n1026, CLK=>D15_c, F0=>I4_n25, Q0=>cnt_1_adj_24);
    I2_SLICE_40I: I2_SLICE_40
      port map (C0=>cnt_2_adj_17, B0=>I2_cnt_0_adj_9, A0=>I2_cnt_1, 
                DI0=>I2_n24, CE=>N_8, LSR=>I2_n1173, CLK=>N_4, F0=>I2_n24, 
                Q0=>cnt_2_adj_17);
    SLICE_41I: SLICE_41
      port map (C0=>cnt_2_adj_19, B0=>cnt_0_adj_21, A0=>cnt_1_adj_20, 
                DI0=>I3_n24, CE=>N_8, LSR=>I3_n1029, CLK=>N_5, F0=>I3_n24, 
                Q0=>cnt_2_adj_19, F1=>VCC_net);
    SLICE_42I: SLICE_42
      port map (D1=>I7_dec_cnt_6, C1=>I7_dec_cnt_5, B1=>I7_dec_cnt_25, 
                A1=>I7_dec_cnt_12, C0=>cnt_2_adj_23, B0=>cnt_0_adj_25, 
                A0=>cnt_1_adj_24, DI0=>I4_n24, CE=>N_8, LSR=>I4_n1026, 
                CLK=>D15_c, F0=>I4_n24, Q0=>cnt_2_adj_23, F1=>I7_n50);
    SLICE_43I: SLICE_43
      port map (B1=>I7_dec_cnt_2, A1=>I7_dec_cnt_26, D0=>cnt_3_adj_18, 
                C0=>cnt_2_adj_19, B0=>cnt_0_adj_21, A0=>cnt_1_adj_20, 
                DI0=>I3_n23, CE=>N_8, LSR=>I3_n1029, CLK=>N_5, F0=>I3_n23, 
                Q0=>cnt_3_adj_18, F1=>I7_n32);
    SLICE_44I: SLICE_44
      port map (B1=>I7_dec_cnt_22, A1=>I7_dec_cnt_4, D0=>cnt_3_adj_22, 
                C0=>cnt_2_adj_23, B0=>cnt_0_adj_25, A0=>cnt_1_adj_24, 
                DI0=>I4_n23, CE=>N_8, LSR=>I4_n1026, CLK=>D15_c, F0=>I4_n23, 
                Q0=>cnt_3_adj_22, F1=>I7_n43);
    I2_i1934_SLICE_45I: I2_i1934_SLICE_45
      port map (C1=>cnt_3, B1=>cnt_3_adj_18, A1=>dec_cnt_1, C0=>dec_cnt_1, 
                B0=>I2_cnt_3, A0=>cnt_3_adj_22, M0=>n2486, OFX0=>n2273);
    I2_i1937_SLICE_46I: I2_i1937_SLICE_46
      port map (C1=>cnt_0, B1=>cnt_0_adj_21, A1=>dec_cnt_1, C0=>dec_cnt_1, 
                B0=>I2_cnt_0_adj_9, A0=>cnt_0_adj_25, M0=>n2486, OFX0=>n2276);
    I2_i1943_SLICE_47I: I2_i1943_SLICE_47
      port map (C1=>cnt_1, B1=>cnt_1_adj_20, A1=>dec_cnt_1, C0=>dec_cnt_1, 
                B0=>I2_cnt_1, A0=>cnt_1_adj_24, M0=>n2486, OFX0=>n2282);
    I7_i1928_SLICE_48I: I7_i1928_SLICE_48
      port map (D1=>cnt_2_adj_17, C1=>cnt_2, B1=>RES_c, A1=>I7_dec_cnt_0, 
                D0=>cnt_2_adj_23, C0=>cnt_2_adj_19, B0=>RES_c, 
                A0=>I7_dec_cnt_0, M0=>I7_n300, OFX0=>I7_n2267);
    I6_i1940_SLICE_49I: I6_i1940_SLICE_49
      port map (C1=>I6_Clk100Hz, B1=>I6_Counter_Clk3Hz, A1=>MR_c_0, C0=>MR_c_0, 
                B0=>I6_Counter_Clk1Hz, A0=>PR_c, M0=>MR_c_1, OFX0=>D15_c);
    I7_SLICE_50I: I7_SLICE_50
      port map (D1=>n2282, C1=>I7_n2480, B1=>RES_c, A1=>I7_s_1, D0=>I7_s_2, 
                C0=>I7_s_0, B0=>I7_s_1, A0=>I7_s_3, F0=>n516, F1=>I7_s_1);
    I7_SLICE_51I: I7_SLICE_51
      port map (D1=>I7_s_3, C1=>I7_n2480, B1=>n2273, A1=>RES_c, D0=>I7_s_2, 
                C0=>I7_s_0, B0=>I7_s_1, A0=>I7_s_3, F0=>n517, F1=>I7_s_3);
    I7_SLICE_52I: I7_SLICE_52
      port map (D1=>I7_s_2, C1=>I7_s_3, B1=>I7_s_1, A1=>I7_s_0, D0=>I7_s_0, 
                C0=>I7_n2480, B0=>n2276, A0=>RES_c, F0=>I7_s_0, F1=>n513);
    I7_SLICE_53I: I7_SLICE_53
      port map (D1=>I7_s_0, C1=>I7_s_2, B1=>I7_s_3, A1=>I7_s_1, D0=>RES_c, 
                C0=>I7_n2480, B0=>I7_n2267, A0=>I7_s_2, F0=>I7_s_2, F1=>n519);
    I2_SLICE_54I: I2_SLICE_54
      port map (C1=>I2_cnt_0_adj_9, B1=>I2_cnt_1, A1=>cnt_2_adj_17, 
                C0=>I2_n2484, B0=>N_8, A0=>I2_cnt_3, F0=>I2_n1173, 
                F1=>I2_n2484);
    SLICE_55I: SLICE_55
      port map (D1=>n4, C1=>cnt_3, B1=>cnt_2, A1=>N_8, B0=>cnt_1, A0=>cnt_0, 
                F0=>n4, F1=>I1_n1036);
    I7_SLICE_56I: I7_SLICE_56
      port map (D1=>I7_n36, C1=>I7_n48, B1=>I7_n54, A1=>I7_n35, 
                B0=>I7_dec_cnt_9, A0=>I7_dec_cnt_15, F0=>I7_n35, F1=>I7_n56);
    I7_SLICE_57I: I7_SLICE_57
      port map (D1=>I7_n44, C1=>I7_n52, B1=>I7_n56, A1=>I7_n43, 
                C0=>I7_dec_cnt_28, B0=>I7_dec_cnt_8, A0=>I7_dec_cnt_14, 
                F0=>I7_n44, F1=>I7_n2205);
    I7_SLICE_58I: I7_SLICE_58
      port map (D1=>I7_dec_cnt_23, C1=>I7_dec_cnt_7, B1=>I7_dec_cnt_30, 
                A1=>I7_dec_cnt_13, D0=>I7_dec_cnt_16, C0=>I7_n32, B0=>I7_n46, 
                A0=>I7_dec_cnt_29, F0=>I7_n52, F1=>I7_n46);
    I7_SLICE_59I: I7_SLICE_59
      port map (B1=>I7_dec_cnt_0, A1=>dec_cnt_1, D0=>SEG_c, C0=>I7_n2485, 
                B0=>I7_n2205, A0=>I7_dec_cnt_31, F0=>SEG_c, F1=>I7_n2485);
    I7_SLICE_60I: I7_SLICE_60
      port map (B1=>I7_n2205, A1=>I7_dec_cnt_31, D0=>I7_dec_cnt_0, 
                C0=>I7_n2480, B0=>dec_cnt_1, A0=>n511, F0=>n511, F1=>I7_n2480);
    I7_SLICE_61I: I7_SLICE_61
      port map (B1=>I7_dec_cnt_0, A1=>dec_cnt_1, D0=>n512, C0=>I7_n239, 
                B0=>I7_n2205, A0=>I7_dec_cnt_31, F0=>n512, F1=>I7_n239);
    I7_SLICE_62I: I7_SLICE_62
      port map (D1=>I7_dec_cnt_10, C1=>I7_n40, B1=>I7_n50, A1=>I7_dec_cnt_20, 
                B0=>I7_dec_cnt_24, A0=>I7_dec_cnt_17, F0=>I7_n40, F1=>I7_n54);
    I6_SLICE_63I: I6_SLICE_63
      port map (D1=>I6_Counter_Counter1Hz_3, C1=>I6_Counter_Counter1Hz_4, 
                B1=>I6_n2489, A1=>I6_Counter_Counter1Hz_2, B0=>I6_n7, 
                A0=>I6_n6, F0=>I6_n2489, F1=>I6_n2481);
    I6_SLICE_64I: I6_SLICE_64
      port map (D1=>I6_n4, C1=>I6_Counter_Counter1Hz_5, 
                B1=>I6_Counter_Counter1Hz_4, A1=>I6_Counter_Counter1Hz_6, 
                B0=>I6_Counter_Counter1Hz_3, A0=>I6_Counter_Counter1Hz_2, 
                F0=>I6_n4, F1=>I6_n1021);
    I6_SLICE_65I: I6_SLICE_65
      port map (D1=>I6_Counter_Counter3Hz_4, C1=>I6_n6_adj_4, 
                B1=>I6_Counter_Counter3Hz_5, A1=>I6_Counter_Counter3Hz_1, 
                B0=>I6_Counter_Counter3Hz_3, A0=>I6_Counter_Counter3Hz_2, 
                F0=>I6_n6_adj_4, F1=>I6_n1023);
    I7_SLICE_66I: I7_SLICE_66
      port map (D1=>I7_s_0, C1=>I7_s_2, B1=>I7_s_3, A1=>I7_s_1, D0=>I7_s_0, 
                C0=>I7_s_3, B0=>I7_s_1, A0=>I7_s_2, F0=>n515, F1=>n518);
    I7_SLICE_67I: I7_SLICE_67
      port map (D1=>I7_dec_cnt_31, C1=>I7_n2205, B1=>I7_dec_cnt_0, 
                A1=>dec_cnt_1, D0=>y_c, C0=>I7_n239, B0=>I7_n2205, 
                A0=>I7_dec_cnt_31, F0=>y_c, F1=>I7_n1022);
    SLICE_68I: SLICE_68
      port map (B1=>RES_c, A1=>Stop_c, B0=>RES_c, A0=>N_8, F0=>n628, F1=>N_10);
    I7_SLICE_69I: I7_SLICE_69
      port map (B1=>RES_c, A1=>I7_dec_cnt_0, D0=>I7_dec_cnt_0, C0=>I7_n2480, 
                B0=>dec_cnt_1, A0=>n510, F0=>n510, F1=>n2486);
    I7_SLICE_70I: I7_SLICE_70
      port map (B1=>I7_dec_cnt_19, A1=>I7_dec_cnt_3, D0=>I7_dec_cnt_21, 
                C0=>I7_dec_cnt_27, B0=>I7_dec_cnt_18, A0=>I7_dec_cnt_11, 
                F0=>I7_n48, F1=>I7_n36);
    I7_SLICE_71I: I7_SLICE_71
      port map (B1=>RES_c, A1=>dec_cnt_1, D0=>I7_s_0, C0=>I7_s_3, B0=>I7_s_1, 
                A0=>I7_s_2, F0=>n514, F1=>I7_n300);
    y_2_I: y_2_B
      port map (PADDO=>n514, y2=>y(2));
    y_3_I: y_3_B
      port map (PADDO=>n515, y3=>y(3));
    y_1_I: y_1_B
      port map (PADDO=>n513, y1=>y(1));
    SEG_0_I: SEG_0_B
      port map (PADDO=>SEG_c, SEG0=>SEG(0));
    SEG_1_I: SEG_1_B
      port map (PADDO=>n512, SEG1=>SEG(1));
    SEG_2_I: SEG_2_B
      port map (PADDO=>n511, SEG2=>SEG(2));
    SEG_3_I: SEG_3_B
      port map (PADDO=>n510, SEG3=>SEG(3));
    D15I: D15B
      port map (PADDO=>D15_c, D15S=>D15);
    StopI: StopB
      port map (PADDI=>Stop_c, StopS=>Stop);
    StartI: StartB
      port map (PADDI=>Start_c, StartS=>Start);
    RESI: RESB
      port map (PADDI=>RES_c, RESS=>RES);
    PRI: PRB
      port map (PADDI=>PR_c, PRS=>PR);
    MR_0_I: MR_0_B
      port map (PADDI=>MR_c_0, MR0=>MR(0));
    MR_1_I: MR_1_B
      port map (PADDI=>MR_c_1, MR1=>MR(1));
    y_8_I: y_8_B
      port map (PADDO=>y_c, y8=>y(8));
    y_7_I: y_7_B
      port map (PADDO=>n519, y7=>y(7));
    y_6_I: y_6_B
      port map (PADDO=>n518, y6=>y(6));
    y_5_I: y_5_B
      port map (PADDO=>n517, y5=>y(5));
    y_4_I: y_4_B
      port map (PADDO=>n516, y4=>y(4));
    GSR_INST: GSR_INSTB
      port map (GSRNET=>RES_c);
    I6_OscInst0I: I6_OscInst0
      port map (OSC=>I6_ClkOsc);
    I6_CTInst0_EFBInst_0I: I6_CTInst0_EFBInst_0
      port map (TCOC=>N_2, TCRSTN=>VCC_net, TCCLKI=>I6_ClkOsc);
    PUR_INST: PUR
  ...
  library IEEE, vital2000, MACHXO2;
  configuration Structure_CON of Stoppuhr is
    for Structure
    end for;
  end Structure_CON;
