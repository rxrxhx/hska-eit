...
set ::bali::simulation::Para(PROJECTPATH) {H:/digitaltechnik_labor/Projects/LAB_ADD}
set ::bali::simulation::Para(FILELIST) {"H:/digitaltechnik_labor/Projects/LAB_ADD/LAB_ADD.vhd" "H:/digitaltechnik_labor/Projects/LAB_ADD/add4_tb.vhd" }
