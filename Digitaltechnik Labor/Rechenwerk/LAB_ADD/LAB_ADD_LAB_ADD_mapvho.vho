...
-- ldbanno -n VHDL -o LAB_ADD_LAB_ADD_mapvho.vho -w -neg -gui LAB_ADD_LAB_ADD_map.ncd 
-- Netlist created on Thu May 10 15:15:34 2018
-- Netlist written on Thu May 10 15:15:37 2018
...
-- entity add4
  ...
  begin
    SLICE_0I: SLICE_0
      port map (D1=>A_c_1, C1=>B_c_1, B1=>A_c_0, A1=>B_c_0, C0=>A_c_2, B0=>n25, 
                A0=>B_c_2, F0=>n43, F1=>n25);
    SLICE_1I: SLICE_1
      port map (B1=>B_c_0, A1=>A_c_0, D0=>B_c_1, C0=>A_c_1, B0=>A_c_0, 
                A0=>B_c_0, F0=>n44, F1=>Z_c);
    SLICE_2I: SLICE_2
      port map (C0=>B_c_2, B0=>n25, A0=>A_c_2, F0=>n42);
    Z_3_I: Z_3_B
      port map (PADDO=>n42, Z3=>Z(3));
    A_0_I: A_0_B
      port map (PADDI=>A_c_0, A0=>A(0));
    Z_1_I: Z_1_B
      port map (PADDO=>n44, Z1=>Z(1));
    Z_2_I: Z_2_B
      port map (PADDO=>n43, Z2=>Z(2));
    A_2_I: A_2_B
  ...
  library IEEE, vital2000, MACHXO2;
  configuration Structure_CON of add4 is
    for Structure
    end for;
  end Structure_CON;
