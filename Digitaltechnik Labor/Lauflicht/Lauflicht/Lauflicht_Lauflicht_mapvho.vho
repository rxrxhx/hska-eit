...
-- ldbanno -n VHDL -o Lauflicht_Lauflicht_mapvho.vho -w -neg -gui Lauflicht_Lauflicht_map.ncd 
-- Netlist created on Tue Jun 19 22:58:28 2018
-- Netlist written on Tue Jun 19 22:58:37 2018
...
-- entity Clock_SLICE_1
  ...
  begin
    Clock_Counter_Counter03Hz_35_i8: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    Clock_Counter_Counter03Hz_35_i7: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    Clock_Counter_Counter03Hz_35_add_4_9: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>open);
    DRIVEGND: gnd
...
-- entity Clock_SLICE_2
  ...
  begin
    Clock_Counter_Counter03Hz_35_i6: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    Clock_Counter_Counter03Hz_35_i5: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    Clock_Counter_Counter03Hz_35_add_4_7: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity Clock_SLICE_3
  ...
  begin
    Clock_Counter_Counter03Hz_35_i0: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    Clock_Counter_Counter03Hz_35_add_4_1: ccu20001
...
-- entity Clock_SLICE_4
  ...
  begin
    Clock_Counter_Counter03Hz_35_i4: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    Clock_Counter_Counter03Hz_35_i3: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    Clock_Counter_Counter03Hz_35_add_4_5: ccu2B0
      port map (A0=>A0_ipd, B0=>GNDI, C0=>GNDI, D0=>GNDI, A1=>A1_ipd, B1=>GNDI, 
                C1=>GNDI, D1=>GNDI, CI=>FCI_ipd, S0=>F0_out, S1=>F1_out, 
                CO1=>FCO_out);
    DRIVEGND: gnd
...
-- entity Clock_SLICE_5
  ...
  begin
    ...
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_i19_1_lut: lut40002
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    Clock_SigClk100Hz_37: vmuxregsre0003
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity Clock_SLICE_7
  ...
  begin
    Clock_i2_4_lut: lut40006
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    Clock_i1_2_lut: lut40005
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_Counter_Clk1Hz_34: vmuxregsre0003
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity Clock_SLICE_8
  ...
  begin
    Clock_i178_4_lut: lut40007
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    Clock_i1_2_lut_adj_1: lut40005
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_Counter_Clk3Hz_32: vmuxregsre0003
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity Clock_SLICE_9
  ...
  begin
    Clock_i207_2_lut_3_lut_4_lut: lut40008
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    Clock_i200_2_lut_3_lut: lut40009
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_Counter_Counter1Hz_33_i3: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    Clock_Counter_Counter1Hz_33_i2: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity Clock_SLICE_10
  ...
  begin
    Clock_i221_2_lut_4_lut: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    Clock_i214_2_lut_3_lut_4_lut: lut40008
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    Clock_Counter_Counter1Hz_33_i5: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    Clock_Counter_Counter1Hz_33_i4: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity Clock_SLICE_11
  ...
  begin
    Clock_i217_2_lut_3_lut_rep_1_4_lut: lut40011
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    Clock_i228_3_lut: lut40012
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_Counter_Counter1Hz_33_i6: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity Clock_SLICE_12
  ...
  begin
    Clock_i250_2_lut_3_lut: lut40009
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_i243_2_lut: lut40005
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    Clock_Counter_Counter3Hz_31_i2: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    Clock_Counter_Counter3Hz_31_i1: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity Clock_SLICE_13
  ...
  begin
    Clock_i264_2_lut_4_lut: lut40010
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    Clock_i257_2_lut_3_lut_4_lut: lut40008
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>D0_ipd, Z=>F0_out);
    Clock_Counter_Counter3Hz_31_i4: vmuxregsre
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    Clock_Counter_Counter3Hz_31_i3: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
...
-- entity Clock_SLICE_14
  ...
  begin
    Clock_i260_2_lut_3_lut_rep_3_4_lut: lut40011
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    Clock_i271_3_lut: lut40012
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_Counter_Counter3Hz_31_i5: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity Clock_SLICE_15
  ...
  begin
    Clock_i196_2_lut_rep_4: lut40013
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_i191_1_lut: lut40002
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    Clock_Counter_Counter1Hz_33_i0: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity Clock_SLICE_16
  ...
  begin
    Clock_i246_2_lut_rep_5: lut40013
      port map (A=>A1_ipd, B=>B1_ipd, C=>GNDI, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_i241_1_lut: lut40002
      port map (A=>A0_ipd, B=>GNDI, C=>GNDI, D=>GNDI, Z=>F0_out);
    Clock_Counter_Counter3Hz_31_i0: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity Clock_SLICE_17
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity Clock_SLICE_17 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "Clock_SLICE_17";
    ...
    ATTRIBUTE Vital_Level0 OF Clock_SLICE_17 : ENTITY IS TRUE;

  end Clock_SLICE_17;

  architecture Structure of Clock_SLICE_17 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
  ...
  begin
    Clock_i203_2_lut_rep_2_3_lut: lut40014
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_i193_2_lut: lut40005
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    Clock_Counter_Counter1Hz_33_i1: vmuxregsre
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>LSR_dly, Q=>Q0_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
...
-- entity SLICE_18
  ...
  begin
    mux_7_i2_3_lut: lut40015
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    mux_7_i1_3_lut: lut40015
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    regi_i1: vmuxregsre0003
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    regi_i0: vmuxregsre0003
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_19
  ...
  begin
    mux_7_i4_3_lut: lut40015
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    mux_7_i3_3_lut: lut40015
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    regi_i3: vmuxregsre0003
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    regi_i2: vmuxregsre0003
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_20
  ...
  begin
    mux_7_i6_3_lut: lut40015
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    mux_7_i5_3_lut: lut40015
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    regi_i5: vmuxregsre0003
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    regi_i4: vmuxregsre0003
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity SLICE_21
  ...
  begin
    mux_7_i8_3_lut: lut40015
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, Z=>F1_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    mux_7_i7_3_lut: lut40015
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, Z=>F0_out);
    regi_i7: vmuxregsre0016
      port map (D0=>VCCI, D1=>DI1_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q1_out);
    DRIVEVCC: vcc
      port map (PWR1=>VCCI);
    regi_i6: vmuxregsre0003
      port map (D0=>VCCI, D1=>DI0_dly, SD=>VCCI, SP=>VCCI, CK=>CLK_dly, 
                LSR=>GNDI, Q=>Q0_out);
...
-- entity Clock_i290_SLICE_22
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity Clock_i290_SLICE_22 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "Clock_i290_SLICE_22";
    ...
    ATTRIBUTE Vital_Level0 OF Clock_i290_SLICE_22 : ENTITY IS TRUE;

  end Clock_i290_SLICE_22;

  architecture Structure of Clock_i290_SLICE_22 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    signal GNDI: Std_logic;
    signal Clock_i290_SLICE_22_Clock_i290_SLICE_22_K1_H1: Std_logic;
    signal Clock_i290_SLICE_22_Clock_i290_GATE_H0: Std_logic;
    component gnd
      port (PWR0: out Std_logic);
    end component;
    component lut40017
  ...
  begin
    Clock_i290_SLICE_22_K1: lut40017
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, 
                Z=>Clock_i290_SLICE_22_Clock_i290_SLICE_22_K1_H1);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_i290_GATE: lut40018
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, 
                Z=>Clock_i290_SLICE_22_Clock_i290_GATE_H0);
    Clock_i290_SLICE_22_K0K1MUX: selmux2
      port map (D0=>Clock_i290_SLICE_22_Clock_i290_GATE_H0, 
                D1=>Clock_i290_SLICE_22_Clock_i290_SLICE_22_K1_H1, SD=>M0_ipd, 
                Z=>OFX0_out);
...
-- entity Clock_i293_SLICE_23
  library IEEE, vital2000, MACHXO2;
  use IEEE.STD_LOGIC_1164.all;
  use vital2000.vital_timing.all;
  use MACHXO2.COMPONENTS.ALL;

  entity Clock_i293_SLICE_23 is
    -- miscellaneous vital GENERICs
    GENERIC (
      TimingChecksOn	: boolean := TRUE;
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "Clock_i293_SLICE_23";
    ...
    ATTRIBUTE Vital_Level0 OF Clock_i293_SLICE_23 : ENTITY IS TRUE;

  end Clock_i293_SLICE_23;

  architecture Structure of Clock_i293_SLICE_23 is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;
    ...
    signal GNDI: Std_logic;
    signal Clock_i293_SLICE_23_Clock_i293_SLICE_23_K1_H1: Std_logic;
    signal Clock_i293_SLICE_23_Clock_i293_GATE_H0: Std_logic;
    component gnd
      port (PWR0: out Std_logic);
    end component;
    component lut40017
  ...
  begin
    Clock_i293_SLICE_23_K1: lut40017
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>GNDI, 
                Z=>Clock_i293_SLICE_23_Clock_i293_SLICE_23_K1_H1);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
    Clock_i293_GATE: lut40018
      port map (A=>A0_ipd, B=>B0_ipd, C=>C0_ipd, D=>GNDI, 
                Z=>Clock_i293_SLICE_23_Clock_i293_GATE_H0);
    Clock_i293_SLICE_23_K0K1MUX: selmux2
      port map (D0=>Clock_i293_SLICE_23_Clock_i293_GATE_H0, 
                D1=>Clock_i293_SLICE_23_Clock_i293_SLICE_23_K1_H1, SD=>M0_ipd, 
                Z=>OFX0_out);
...
-- entity Clock_SLICE_24
  ...
  begin
    Clock_i2_4_lut_adj_3: lut40019
      port map (A=>A1_ipd, B=>B1_ipd, C=>C1_ipd, D=>D1_ipd, Z=>F1_out);
    Clock_i1_2_lut_adj_2: lut40013
      port map (A=>A0_ipd, B=>B0_ipd, C=>GNDI, D=>GNDI, Z=>F0_out);
    DRIVEGND: gnd
      port map (PWR0=>GNDI);
...
-- entity xo2iobuf0021
  ...
  entity xo2iobuf0021 is
    port (Z: out Std_logic; PAD: in Std_logic);

    ATTRIBUTE Vital_Level0 OF xo2iobuf0021 : ENTITY IS TRUE;

  end xo2iobuf0021;

  architecture Structure of xo2iobuf0021 is
  begin
    INST1: IBPD
      port map (I=>PAD, O=>Z);
  end Structure;
...
-- entity DIRB
  ...
  architecture Structure of DIRB is
    ...
    component xo2iobuf0021
      port (Z: out Std_logic; PAD: in Std_logic);
    end component;
  begin
    DIR_pad: xo2iobuf0021
...
-- entity INVB
  ...
  entity INVB is
    ...
    GENERIC (
      ...
      XOn           	: boolean := FALSE;
      MsgOn         	: boolean := TRUE;
      InstancePath  	: string := "INVB";

      tipd_INVS  	: VitalDelayType01 := (0 ns, 0 ns);
      tpd_INVS_PADDI	 : VitalDelayType01 := (0 ns, 0 ns);
      tperiod_INVS 	: VitalDelayType := 0 ns;
      tpw_INVS_posedge	: VitalDelayType := 0 ns;
      tpw_INVS_negedge	: VitalDelayType := 0 ns);

    port (PADDI: out Std_logic; INVS: in Std_logic);

    ATTRIBUTE Vital_Level0 OF INVB : ENTITY IS TRUE;

  end INVB;

  architecture Structure of INVB is
    ATTRIBUTE Vital_Level0 OF Structure : ARCHITECTURE IS TRUE;

    signal PADDI_out 	: std_logic := 'X';
    signal INVS_ipd 	: std_logic := 'X';

    component xo2iobuf0021
      port (Z: out Std_logic; PAD: in Std_logic);
    end component;
  begin
    INV_pad: xo2iobuf0021
      port map (Z=>PADDI_out, PAD=>INVS_ipd);

    --  INPUT PATH DELAYs
    WireDelay : BLOCK
    BEGIN
      VitalWireDelay(INVS_ipd, INVS, tipd_INVS);
    END BLOCK;

    VitalBehavior : PROCESS (PADDI_out, INVS_ipd)
    VARIABLE PADDI_zd         	: std_logic := 'X';
    VARIABLE PADDI_GlitchData 	: VitalGlitchDataType;

    VARIABLE tviol_INVS_INVS          	: x01 := '0';
    VARIABLE periodcheckinfo_INVS	: VitalPeriodDataType;
    ...
    IF (TimingChecksOn) THEN
      VitalPeriodPulseCheck (
        ...
        TestSignalName => "INVS",
        Period => tperiod_INVS,
        PulseWidthHigh => tpw_INVS_posedge,
        PulseWidthLow => tpw_INVS_negedge,
        PeriodData => periodcheckinfo_INVS,
        Violation => tviol_INVS_INVS,
        MsgOn => MsgOn, XOn => XOn,
        HeaderMsg => InstancePath,
        CheckEnabled => TRUE,
        MsgSeverity => warning);
    ...
    VitalPathDelay01 (
      OutSignal => PADDI, OutSignalName => "PADDI", OutTemp => PADDI_zd,
      Paths      => (0 => (InputChangeTime => INVS_ipd'last_event,
                           PathDelay => tpd_INVS_PADDI,
                           PathCondition => TRUE)),
      GlitchData => PADDI_GlitchData,
      Mode       => vitaltransport, XOn => XOn, MsgOn => MsgOn);
...
-- entity lauflicht
  ...
  entity lauflicht is
    port (LED: out Std_logic_vector (7 downto 0); DIR: in Std_logic; 
          INV: in Std_logic; MLEFT: in Std_logic_vector (1 downto 0); 
          MRIGHT: in Std_logic_vector (1 downto 0); TLEFT: in Std_logic; 
          TRIGHT: in Std_logic; D14: out Std_logic; D15: out Std_logic);
  ...
  architecture Structure of lauflicht is
    ...
    signal Clock_n130: Std_logic;
    signal Clock_Clk200Hz: Std_logic;
    signal Clock_n327: Std_logic;
    signal Clock_n328: Std_logic;
    ...
    signal Clock_n132: Std_logic;
    signal Clock_Counter_Clk1Hz: Std_logic;
    signal Clock_n106: Std_logic;
    ...
    signal Clock_n36_adj_4: Std_logic;
    ...
    signal Clock_n35_adj_2: Std_logic;
    signal Clock_n357: Std_logic;
    ...
    signal regi_2: Std_logic;
    signal regi_0: Std_logic;
    signal regi_1: Std_logic;
    signal regi_7: Std_logic;
    signal n27: Std_logic;
    signal n365: Std_logic;
    signal D14_c: Std_logic;
    signal regi_4: Std_logic;
    signal regi_3: Std_logic;
    signal n25: Std_logic;
    signal n26: Std_logic;
    signal regi_6: Std_logic;
    signal regi_5: Std_logic;
    ...
    signal Clock_n4_adj_3: Std_logic;
    ...
    component Clock_i290_SLICE_22
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            M0: in Std_logic; OFX0: out Std_logic);
    end component;
    component Clock_i293_SLICE_23
      port (C1: in Std_logic; B1: in Std_logic; A1: in Std_logic; 
            C0: in Std_logic; B0: in Std_logic; A0: in Std_logic; 
            M0: in Std_logic; OFX0: out Std_logic);
    end component;
  ...
  begin
    Clock_SLICE_0I: Clock_SLICE_0
      port map (A1=>Clock_Counter_Counter03Hz_2, 
                ...
                DI0=>Clock_n50, LSR=>Clock_n130, CLK=>Clock_Clk200Hz, 
                FCI=>Clock_n327, F0=>Clock_n50, 
                Q0=>Clock_Counter_Counter03Hz_1, F1=>Clock_n49, 
                Q1=>Clock_Counter_Counter03Hz_2, FCO=>Clock_n328);
    Clock_SLICE_1I: Clock_SLICE_1
      port map (A1=>Clock_Counter_Counter03Hz_8, 
                A0=>Clock_Counter_Counter03Hz_7, DI1=>Clock_n43, 
                DI0=>Clock_n44, LSR=>Clock_n130, CLK=>Clock_Clk200Hz, 
                FCI=>Clock_n330, F0=>Clock_n44, 
    ...
    Clock_SLICE_2I: Clock_SLICE_2
      port map (A1=>Clock_Counter_Counter03Hz_6, 
                ...
                DI0=>Clock_n46, LSR=>Clock_n130, CLK=>Clock_Clk200Hz, 
                FCI=>Clock_n329, F0=>Clock_n46, 
                Q0=>Clock_Counter_Counter03Hz_5, F1=>Clock_n45, 
                Q1=>Clock_Counter_Counter03Hz_6, FCO=>Clock_n330);
    Clock_SLICE_3I: Clock_SLICE_3
      port map (A1=>Clock_n9, DI1=>Clock_n51, LSR=>Clock_n130, 
    ...
    Clock_SLICE_4I: Clock_SLICE_4
      port map (A1=>Clock_Counter_Counter03Hz_4, 
                ...
                DI0=>Clock_n48, LSR=>Clock_n130, CLK=>Clock_Clk200Hz, 
                FCI=>Clock_n328, F0=>Clock_n48, 
                Q0=>Clock_Counter_Counter03Hz_3, F1=>Clock_n47, 
                Q1=>Clock_Counter_Counter03Hz_4, FCO=>Clock_n329);
    Clock_SLICE_5I: Clock_SLICE_5
      port map (B1=>Clock_Counter_Counter3Hz_4, A1=>Clock_Counter_Counter3Hz_2, 
                A0=>Clock_Clk100Hz, DI0=>Clock_n71, CLK=>Clock_Clk200Hz, 
                F0=>Clock_n71, Q0=>Clock_Clk100Hz, F1=>Clock_n6);
    Clock_SLICE_6I: Clock_SLICE_6
      port map (D1=>Clock_n336, C1=>Clock_Counter_Counter03Hz_6, 
                B1=>Clock_Counter_Counter03Hz_8, 
                A1=>Clock_Counter_Counter03Hz_7, B0=>Clock_n130, 
                A0=>Clock_Counter_Clk03Hz, DI0=>Clock_n108, 
                CLK=>Clock_Clk200Hz, F0=>Clock_n108, Q0=>Clock_Counter_Clk03Hz, 
                F1=>Clock_n130);
    Clock_SLICE_7I: Clock_SLICE_7
      port map (D1=>Clock_n4, C1=>Clock_Counter_Counter1Hz_5, 
                B1=>Clock_Counter_Counter1Hz_4, A1=>Clock_Counter_Counter1Hz_6, 
                B0=>Clock_n132, A0=>Clock_Counter_Clk1Hz, DI0=>Clock_n106, 
                CLK=>Clock_Clk200Hz, F0=>Clock_n106, Q0=>Clock_Counter_Clk1Hz, 
                F1=>Clock_n132);
    Clock_SLICE_8I: Clock_SLICE_8
      port map (D1=>Clock_Counter_Counter3Hz_3, C1=>Clock_n6, 
                B1=>Clock_Counter_Counter3Hz_5, A1=>Clock_Counter_Counter3Hz_1, 
                B0=>Clock_n131, A0=>Clock_Counter_Clk3Hz, DI0=>Clock_n104, 
                CLK=>Clock_Clk200Hz, F0=>Clock_n104, Q0=>Clock_Counter_Clk3Hz, 
                F1=>Clock_n131);
    Clock_SLICE_9I: Clock_SLICE_9
      port map (D1=>Clock_Counter_Counter1Hz_2, C1=>Clock_Counter_Counter1Hz_3, 
                B1=>Clock_n7, A1=>Clock_n6_adj_5, 
                C0=>Clock_Counter_Counter1Hz_2, B0=>Clock_n7, 
                A0=>Clock_n6_adj_5, DI1=>Clock_n38, DI0=>Clock_n39, 
                LSR=>Clock_n132, CLK=>Clock_Clk200Hz, F0=>Clock_n39, 
                Q0=>Clock_Counter_Counter1Hz_2, F1=>Clock_n38, 
                Q1=>Clock_Counter_Counter1Hz_3);
    Clock_SLICE_10I: Clock_SLICE_10
      port map (D1=>Clock_Counter_Counter1Hz_5, C1=>Clock_Counter_Counter1Hz_4, 
                B1=>Clock_n354, A1=>Clock_Counter_Counter1Hz_3, 
                D0=>Clock_Counter_Counter1Hz_3, C0=>Clock_Counter_Counter1Hz_4, 
                B0=>Clock_n356, A0=>Clock_Counter_Counter1Hz_2, 
                DI1=>Clock_n36_adj_4, DI0=>Clock_n37, LSR=>Clock_n132, 
                CLK=>Clock_Clk200Hz, F0=>Clock_n37, 
                Q0=>Clock_Counter_Counter1Hz_4, F1=>Clock_n36_adj_4, 
                Q1=>Clock_Counter_Counter1Hz_5);
    Clock_SLICE_11I: Clock_SLICE_11
      port map (D1=>Clock_Counter_Counter1Hz_3, C1=>Clock_Counter_Counter1Hz_4, 
                B1=>Clock_n356, A1=>Clock_Counter_Counter1Hz_2, C0=>Clock_n353, 
                B0=>Clock_Counter_Counter1Hz_5, A0=>Clock_Counter_Counter1Hz_6, 
                DI0=>Clock_n35, LSR=>Clock_n132, CLK=>Clock_Clk200Hz, 
                F0=>Clock_n35, Q0=>Clock_Counter_Counter1Hz_6, F1=>Clock_n353);
    Clock_SLICE_12I: Clock_SLICE_12
      port map (C1=>Clock_Counter_Counter3Hz_2, B1=>Clock_n6_adj_1, 
                ...
                A0=>Clock_Counter_Counter3Hz_1, DI1=>Clock_n1, 
                DI0=>Clock_n35_adj_2, LSR=>Clock_n131, CLK=>Clock_Clk200Hz, 
                F0=>Clock_n35_adj_2, Q0=>Clock_Counter_Counter3Hz_1, 
                F1=>Clock_n1, Q1=>Clock_Counter_Counter3Hz_2);
    Clock_SLICE_13I: Clock_SLICE_13
      port map (D1=>Clock_Counter_Counter3Hz_4, C1=>Clock_Counter_Counter3Hz_3, 
                B1=>Clock_n357, A1=>Clock_Counter_Counter3Hz_2, 
                D0=>Clock_Counter_Counter3Hz_2, C0=>Clock_Counter_Counter3Hz_3, 
                B0=>Clock_n6_adj_1, A0=>Clock_Counter_Counter3Hz_1, 
                DI1=>Clock_n32, DI0=>Clock_n33, LSR=>Clock_n131, 
    ...
    Clock_SLICE_14I: Clock_SLICE_14
      port map (D1=>Clock_Counter_Counter3Hz_2, C1=>Clock_Counter_Counter3Hz_3, 
                ...
                C0=>Clock_n355, B0=>Clock_Counter_Counter3Hz_4, 
                A0=>Clock_Counter_Counter3Hz_5, DI0=>Clock_n31, 
                LSR=>Clock_n131, CLK=>Clock_Clk200Hz, F0=>Clock_n31, 
                Q0=>Clock_Counter_Counter3Hz_5, F1=>Clock_n355);
    Clock_SLICE_15I: Clock_SLICE_15
      port map (B1=>Clock_n7, A1=>Clock_n6_adj_5, A0=>Clock_n7, DI0=>Clock_n41, 
                LSR=>Clock_n132, CLK=>Clock_Clk200Hz, F0=>Clock_n41, 
                Q0=>Clock_n7, F1=>Clock_n356);
    Clock_SLICE_16I: Clock_SLICE_16
      port map (B1=>Clock_n6_adj_1, A1=>Clock_Counter_Counter3Hz_1, 
                A0=>Clock_n6_adj_1, DI0=>Clock_n36, LSR=>Clock_n131, 
                CLK=>Clock_Clk200Hz, F0=>Clock_n36, Q0=>Clock_n6_adj_1, 
                F1=>Clock_n357);
    Clock_SLICE_17I: Clock_SLICE_17
      port map (C1=>Clock_Counter_Counter1Hz_2, B1=>Clock_n7, 
                A1=>Clock_n6_adj_5, B0=>Clock_n7, A0=>Clock_n6_adj_5, 
                DI0=>Clock_n40, LSR=>Clock_n132, CLK=>Clock_Clk200Hz, 
                F0=>Clock_n40, Q0=>Clock_n6_adj_5, F1=>Clock_n354);
    SLICE_18I: SLICE_18
      port map (C1=>DIR_c, B1=>regi_2, A1=>regi_0, C0=>DIR_c, B0=>regi_1, 
                A0=>regi_7, DI1=>n27, DI0=>n365, CLK=>D14_c, F0=>n365, 
                Q0=>regi_0, F1=>n27, Q1=>regi_1);
    SLICE_19I: SLICE_19
      port map (C1=>DIR_c, B1=>regi_4, A1=>regi_2, C0=>DIR_c, B0=>regi_3, 
                A0=>regi_1, DI1=>n25, DI0=>n26, CLK=>D14_c, F0=>n26, 
                Q0=>regi_2, F1=>n25, Q1=>regi_3);
    SLICE_20I: SLICE_20
      port map (C1=>DIR_c, B1=>regi_6, A1=>regi_4, C0=>DIR_c, B0=>regi_5, 
                A0=>regi_3, DI1=>n23, DI0=>n24, CLK=>D14_c, F0=>n24, 
                Q0=>regi_4, F1=>n23, Q1=>regi_5);
    SLICE_21I: SLICE_21
      port map (C1=>DIR_c, B1=>regi_0, A1=>regi_6, C0=>DIR_c, B0=>regi_7, 
                A0=>regi_5, DI1=>n21, DI0=>n22, CLK=>D14_c, F0=>n22, 
                Q0=>regi_6, F1=>n21, Q1=>regi_7);
    Clock_i290_SLICE_22I: Clock_i290_SLICE_22
    ...
    Clock_i293_SLICE_23I: Clock_i293_SLICE_23
    ...
    Clock_SLICE_24I: Clock_SLICE_24
      port map (D1=>Clock_Counter_Counter03Hz_4, C1=>Clock_n4_adj_3, 
                B1=>Clock_Counter_Counter03Hz_5, 
                A1=>Clock_Counter_Counter03Hz_1, 
                B0=>Clock_Counter_Counter03Hz_2, 
                A0=>Clock_Counter_Counter03Hz_3, F0=>Clock_n4_adj_3, 
                F1=>Clock_n336);
    SLICE_25I: SLICE_25
      port map (B1=>INV_c, A1=>regi_2, B0=>INV_c, A0=>regi_3, F0=>n100, 
                F1=>n101);
    SLICE_26I: SLICE_26
      port map (B1=>INV_c, A1=>regi_1, B0=>INV_c, A0=>regi_4, F0=>n99, 
                F1=>n102);
    SLICE_27I: SLICE_27
      port map (B1=>INV_c, A1=>regi_0, B0=>INV_c, A0=>regi_7, F0=>n96, 
                F1=>LED_c);
    SLICE_28I: SLICE_28
      port map (B1=>INV_c, A1=>regi_5, B0=>INV_c, A0=>regi_6, F0=>n97, F1=>n98);
    SLICE_29I: SLICE_29
      port map (B0=>Clock_Counter_Counter1Hz_3, A0=>Clock_Counter_Counter1Hz_2, 
                F0=>Clock_n4, F1=>VCC_net);
    LED_5_I: LED_5_B
      port map (PADDO=>n98, LED5=>LED(5));
    LED_6_I: LED_6_B
      port map (PADDO=>n97, LED6=>LED(6));
    LED_7_I: LED_7_B
      port map (PADDO=>n96, LED7=>LED(7));
    LED_4_I: LED_4_B
      port map (PADDO=>n99, LED4=>LED(4));
    LED_3_I: LED_3_B
      port map (PADDO=>n100, LED3=>LED(3));
    LED_2_I: LED_2_B
      port map (PADDO=>n101, LED2=>LED(2));
    LED_1_I: LED_1_B
      port map (PADDO=>n102, LED1=>LED(1));
    LED_0_I: LED_0_B
